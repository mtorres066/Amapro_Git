...
Begin VB.Form ParosGrupos 
   BackColor       =   &H0080C0FF&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Grupos De Paro"
   ClientHeight    =   5175
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   8415
   Icon            =   "ParosGrupos.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5175
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   1
      Left            =   120
      MouseIcon       =   "ParosGrupos.frx":0442
      Picture         =   "ParosGrupos.frx":0884
      Style           =   1  'Graphical
      TabIndex        =   25
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   2
      Left            =   480
      MouseIcon       =   "ParosGrupos.frx":0DB6
      Picture         =   "ParosGrupos.frx":11F8
      Style           =   1  'Graphical
      TabIndex        =   24
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   3
      Left            =   7440
      MouseIcon       =   "ParosGrupos.frx":172A
      Picture         =   "ParosGrupos.frx":1B6C
      Style           =   1  'Graphical
      TabIndex        =   23
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   4
      Left            =   7800
      MouseIcon       =   "ParosGrupos.frx":209E
      Picture         =   "ParosGrupos.frx":24E0
      Style           =   1  'Graphical
      TabIndex        =   22
   ...
   Begin TabDlg.SSTab TabPuestos 
      ...
      TabPicture(0)   =   "ParosGrupos.frx":2A12
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "FramePuestos"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Vista General"
      TabPicture(1)   =   "ParosGrupos.frx":2D2C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "DataGrid1"
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "Busqueda De Datos"
      TabPicture(2)   =   "ParosGrupos.frx":317E
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   5
      Left            =   6360
      MouseIcon       =   "ParosGrupos.frx":3D1C
      Picture         =   "ParosGrupos.frx":415E
      Style           =   1  'Graphical
      TabIndex        =   8
      Top             =   4320
      Width           =   1000
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   4
      Left            =   5280
      MouseIcon       =   "ParosGrupos.frx":61D0
      Picture         =   "ParosGrupos.frx":6612
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   4320
      Width           =   1000
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   3
      Left            =   4200
      MouseIcon       =   "ParosGrupos.frx":6B44
      Picture         =   "ParosGrupos.frx":6F86
      Style           =   1  'Graphical
      TabIndex        =   6
      Top             =   4320
      Width           =   1000
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   2
      Left            =   3120
      MouseIcon       =   "ParosGrupos.frx":74B8
      Picture         =   "ParosGrupos.frx":78FA
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   4320
      Width           =   1000
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   1
      Left            =   2040
      MouseIcon       =   "ParosGrupos.frx":7E2C
      Picture         =   "ParosGrupos.frx":826E
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   4320
      Width           =   1000
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   0
      Left            =   960
      MouseIcon       =   "ParosGrupos.frx":87A0
      Picture         =   "ParosGrupos.frx":8BE2
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   4320
      Width           =   1000
    ...
    On Error Resume Next
            ...
            ElseIf Index = 2 Then
                    If BEditar = False Then 'ESTA AGREGANDO UN REGISTRO
                         Conexion.Execute "Insert Into ParosGrupos Values('" & TxtTexto.Item(0).Text & "', '" & TxtTexto.Item(1).Text & "', '" & TxtTexto.Item(2).Text & "')"
                    Else 'ESTA EDITANDO UN REGISTRO
                         Conexion.Execute "UPDATE ParosGrupos SET Descripcion = '" & TxtTexto.Item(1).Text & "', Usuario = '" & TxtTexto.Item(2).Text & "' Where CodigoGrupo = '" & TxtTexto.Item(0).Text & "'"
                    End If
...
Private Sub CmdBuscar_Click(Index As Integer)
        ...
        If Index = 0 Then
            If OptCodigo.Value = True Then
                If GOrigenDeDatos = "AmaproAccess" Then
                    Call Abrir_Recordset(RGrupos, "Select * from ParosGrupos where CodigoGrupo Like '%" & TxtBuscar.Text & "%'")
                Else 'ORACLE
                    Call Abrir_Recordset(RGrupos, "Select * from ParosGrupos where UPPER(CodigoGrupo) Like '%" & UCase(TxtBuscar.Text) & "%'")
                End If
            ElseIf OptDescripcion.Value = True Then
                If GOrigenDeDatos = "AmaproAccess" Then
                    Call Abrir_Recordset(RGrupos, "Select * from ParosGrupos where Descripcion Like '%" & TxtBuscar.Text & "%'")
                Else 'ORACLE
                    Call Abrir_Recordset(RGrupos, "Select * from ParosGrupos where UPPER(Descripcion) Like '%" & UCase(TxtBuscar.Text) & "%'")
                End If
            End If
        'SELECCIONAR TODOS LOS DATOS
        ElseIf Index = 1 Then
                Call Abrir_Recordset(RGrupos, "Select * From ParosGrupos")
        End If
        
        Set DataGrid1.DataSource = RGrupos
...
On Error Resume Next
                RGrupos.Sort = RGrupos.Fields(ColIndex).Name
...
On Error Resume Next
        TxtTexto.Item(0).Text = RGrupos!CodigoGrupo
        TxtTexto.Item(1).Text = RGrupos!Descripcion
        TxtTexto.Item(2).Text = RGrupos!Usuario
        If Err <> 0 Then
        End If
End Sub
