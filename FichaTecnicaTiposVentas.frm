...
Begin VB.Form FichaTecnicaTiposVentas 
   BackColor       =   &H000000FF&
   ...
   ClientTop       =   330
   ClientWidth     =   8610
   Icon            =   "FichaTecnicaTiposVentas.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5520
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   1
      Left            =   240
      MouseIcon       =   "FichaTecnicaTiposVentas.frx":0442
      Picture         =   "FichaTecnicaTiposVentas.frx":0884
      Style           =   1  'Graphical
      TabIndex        =   25
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   2
      Left            =   600
      MouseIcon       =   "FichaTecnicaTiposVentas.frx":0DB6
      Picture         =   "FichaTecnicaTiposVentas.frx":11F8
      Style           =   1  'Graphical
      TabIndex        =   24
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   3
      Left            =   7560
      MouseIcon       =   "FichaTecnicaTiposVentas.frx":172A
      Picture         =   "FichaTecnicaTiposVentas.frx":1B6C
      Style           =   1  'Graphical
      TabIndex        =   23
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   4
      Left            =   7920
      MouseIcon       =   "FichaTecnicaTiposVentas.frx":209E
      Picture         =   "FichaTecnicaTiposVentas.frx":24E0
      Style           =   1  'Graphical
      TabIndex        =   22
   ...
   Begin TabDlg.SSTab TabPuestos 
      ...
      TabPicture(0)   =   "FichaTecnicaTiposVentas.frx":2A12
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "FramePuestos"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Vista General"
      TabPicture(1)   =   "FichaTecnicaTiposVentas.frx":2D2C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "DataGrid1"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "Busqueda De Datos"
      TabPicture(2)   =   "FichaTecnicaTiposVentas.frx":317E
      ...
      Begin VB.CommandButton CmdBuscar 
         ...
         Index           =   1
         Left            =   -68760
         Picture         =   "FichaTecnicaTiposVentas.frx":35D0
         Style           =   1  'Graphical
         TabIndex        =   21
         Top             =   3240
         Width           =   2055
      ...
      Begin VB.CommandButton CmdBuscar 
         ...
         Index           =   0
         Left            =   -68760
         Picture         =   "FichaTecnicaTiposVentas.frx":38DA
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   2280
         Width           =   2055
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   5
      Left            =   6480
      MouseIcon       =   "FichaTecnicaTiposVentas.frx":3D1C
      Picture         =   "FichaTecnicaTiposVentas.frx":415E
      Style           =   1  'Graphical
      TabIndex        =   8
      Top             =   4440
      Width           =   1000
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   4
      Left            =   5400
      MouseIcon       =   "FichaTecnicaTiposVentas.frx":4679
      Picture         =   "FichaTecnicaTiposVentas.frx":4ABB
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   4440
      Width           =   1000
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   3
      Left            =   4320
      MouseIcon       =   "FichaTecnicaTiposVentas.frx":5083
      Picture         =   "FichaTecnicaTiposVentas.frx":54C5
      Style           =   1  'Graphical
      TabIndex        =   6
      Top             =   4440
      Width           =   1000
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   2
      Left            =   3240
      MouseIcon       =   "FichaTecnicaTiposVentas.frx":59FC
      Picture         =   "FichaTecnicaTiposVentas.frx":5E3E
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   4440
      Width           =   1000
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   1
      Left            =   2160
      MouseIcon       =   "FichaTecnicaTiposVentas.frx":639A
      Picture         =   "FichaTecnicaTiposVentas.frx":67DC
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   4440
      Width           =   1000
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   0
      Left            =   1080
      MouseIcon       =   "FichaTecnicaTiposVentas.frx":6BB3
      Picture         =   "FichaTecnicaTiposVentas.frx":6FF5
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   4440
      Width           =   1000
   End
End
Attribute VB_Name = "FichaTecnicaTiposVentas"
    ...
    On Error Resume Next
            ...
            ElseIf Index = 2 Then
                    If BEditar = False Then 'ESTA AGREGANDO UN REGISTRO
                         Conexion.Execute "Insert Into FichaTecnicaTiposVentas Values('" & Txttexto.Item(0).Text & "', '" & Txttexto.Item(1).Text & "', '" & Txttexto.Item(2).Text & "')"
                    Else 'ESTA EDITANDO UN REGISTRO
                         Conexion.Execute "UPDATE FichaTecnicaTiposVentas SET Descripcion = '" & Txttexto.Item(1).Text & "', Usuario = '" & Txttexto.Item(2).Text & "' Where Codigo = '" & Txttexto.Item(0).Text & "'"
                    End If
                    
                    'SI SE DUPLICA LA LLAVE
                     If GOrigenDeDatos = "AmaproAccess" Then
                        If Err = -2147467259 Then
                            MsgBox "Codigo De Tipo Ya Existe", vbOKOnly + vbInformation, "Informacion"
                            Txttexto.Item(0).SetFocus
                            Exit Sub
...
Private Sub CmdBuscar_Click(Index As Integer)
        ...
        If Index = 0 Then
            If OptCodigo.Value = True Then
                If GOrigenDeDatos = "AmaproAccess" Then
                    Call Abrir_Recordset(RDocumentos, "Select * from FichaTecnicaTiposVentas where Codigo Like '%" & TxtBuscar.Text & "%'")
                Else 'ORACLE
                    Call Abrir_Recordset(RDocumentos, "Select * from FichaTecnicaTiposVentas where UPPER(Codigo) Like '%" & UCase(TxtBuscar.Text) & "%'")
                End If
            ElseIf OptDescripcion.Value = True Then
                If GOrigenDeDatos = "AmaproAccess" Then
                    Call Abrir_Recordset(RDocumentos, "Select * from FichaTecnicaTiposVentas where Descripcion Like '%" & TxtBuscar.Text & "%'")
                Else 'ORACLE
                    Call Abrir_Recordset(RDocumentos, "Select * from FichaTecnicaTiposVentas where UPPER(Descripcion) Like '%" & UCase(TxtBuscar.Text) & "%'")
                End If
            End If
        'SELECCIONAR TODOS LOS DATOS
        ElseIf Index = 1 Then
                Call Abrir_Recordset(RDocumentos, "Select * From FichaTecnicaTiposVentas")
        End If
...
Private Sub Form_Load()
        Set RDocumentos = New ADODB.Recordset
        Call Abrir_Recordset(RDocumentos, "Select * From FichaTecnicaTiposVentas order by codigo")
        Set DataGrid1.DataSource = RDocumentos
        Llena_Campos
End Sub
