...
Begin VB.Form CerrarPedidoProveedores 
   BackColor       =   &H00008000&
   Caption         =   "Cerrar Pedidos De Proveedores"
   ClientHeight    =   8595
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11880
   Icon            =   "CerrarPedidoProveedores.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8595
   ScaleWidth      =   11880
   ...
   Begin VB.Frame FrameBusqueda 
      ...
      Begin VB.CommandButton CmdSale 
         Height          =   615
         Left            =   8160
         Picture         =   "CerrarPedidoProveedores.frx":08CA
         Style           =   1  'Graphical
         TabIndex        =   30
      ...
      Begin MSDBGrid.DBGrid DBGridBusqueda 
         Bindings        =   "CerrarPedidoProveedores.frx":293C
         Height          =   7215
         Left            =   120
         OleObjectBlob   =   "CerrarPedidoProveedores.frx":2957
         TabIndex        =   26
   ...
   Begin VB.Data DataCerrarPedidos 
      ...
      ReadOnly        =   0   'False
      RecordsetType   =   1  'Dynaset
      RecordSource    =   "CerrarPedidoProveedores"
      Top             =   8040
      Width           =   11775
   End
   Begin TabDlg.SSTab TabDepartamentos 
      ...
      TabPicture(0)   =   "CerrarPedidoProveedores.frx":3331
      ...
      TabPicture(1)   =   "CerrarPedidoProveedores.frx":364B
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "DGridCerrarPedidos"
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "Busqueda"
      TabPicture(2)   =   "CerrarPedidoProveedores.frx":3A9D
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "FrameBusquedadeDatos"
      Tab(2).ControlCount=   1
      Begin MSDBGrid.DBGrid DGridCerrarPedidos 
         Bindings        =   "CerrarPedidoProveedores.frx":3EEF
         Height          =   7095
         Left            =   -74880
         OleObjectBlob   =   "CerrarPedidoProveedores.frx":3F0F
         TabIndex        =   12
      ...
      Begin VB.Frame FrameBusquedadeDatos 
         ...
         Begin VB.OptionButton OptBusqueda 
            ...
            Index           =   2
            Left            =   3000
            Picture         =   "CerrarPedidoProveedores.frx":5325
            Style           =   1  'Graphical
            TabIndex        =   16
            Top             =   360
            Width           =   1335
         ...
         Begin VB.OptionButton OptBusqueda 
            ...
            Index           =   1
            Left            =   1560
            Picture         =   "CerrarPedidoProveedores.frx":562F
            Style           =   1  'Graphical
            TabIndex        =   15
            Top             =   360
            Width           =   1335
         ...
         Begin VB.OptionButton OptBusqueda 
            ...
            Index           =   0
            Left            =   120
            Picture         =   "CerrarPedidoProveedores.frx":84A9
            Style           =   1  'Graphical
            TabIndex        =   14
            Top             =   360
            Value           =   -1  'True
         ...
         Begin MSForms.CommandButton CmdBotones 
            ...
            Size            =   "4471;1085"
            Picture         =   "CerrarPedidoProveedores.frx":DAAB
      ...
      Begin MSForms.CommandButton CmdBotones 
         ...
         PicturePosition =   196613
         Size            =   "3881;1085"
         Picture         =   "CerrarPedidoProveedores.frx":DEFD
         Accelerator     =   83
         FontEffects     =   1073741825
         FontHeight      =   165
         FontCharSet     =   0
      ...
      Begin MSForms.CommandButton CmdBotones 
         ...
         PicturePosition =   196613
         Size            =   "3881;1085"
         Picture         =   "CerrarPedidoProveedores.frx":FF7F
         Accelerator     =   66
         FontEffects     =   1073741825
         FontHeight      =   165
         FontCharSet     =   0
      ...
      Begin MSForms.CommandButton CmdBotones 
         ...
         PicturePosition =   196613
         Size            =   "3881;1085"
         Picture         =   "CerrarPedidoProveedores.frx":104C1
         Accelerator     =   67
      ...
      Begin MSForms.CommandButton CmdBotones 
         ...
         PicturePosition =   196613
         Size            =   "3881;1085"
         Picture         =   "CerrarPedidoProveedores.frx":10A03
         Accelerator     =   65
         FontEffects     =   1073741825
         FontHeight      =   165
         FontCharSet     =   0
   ...
   End
End
Attribute VB_Name = "CerrarPedidoProveedores"
...
On Error Resume Next
    With DataCerrarPedidos.Recordset
        ...
        ElseIf Index = 2 Then
                ...
                Set RBuscaPedido2 = Db.OpenRecordset("Select * From EncabezadoPedidosProveedores Where Documento = '" & TxtTexto.Item(2).Text & "'")
                ...
                Set RBuscaPedido3 = Db.OpenRecordset("Select * From DetallePedidosProveedores Where Documento = '" & TxtTexto.Item(2).Text & "' And Codigo = '" & TxtTexto.Item(1).Text & "'")
                ...
                Set RBuscaSaldoEncabezado = Db.OpenRecordset("Select SaldoPorEntregar From DetallePedidosProveedores Where Documento = '" & TxtTexto.Item(2).Text & "' And Codigo = '" & TxtTexto.Item(1).Text & "'")
                ...
                '________________________________________________________________________________________________________
                           ...
                           '
                            ...
                            'Set RBuscaPedido = Db.OpenRecordset("Select Sum(Cantidad) From CerrarPedidoProveedores Where Documento = '" & TxtTexto.Item(0).Text & "' And CodigoMateriaPrima = '" & TxtTexto.Item(1).Text & "'")
                ...
                Set RBuscaPedido = Db.OpenRecordset("Select CantidadEntregada, SaldoPorEntregar, FechaParaEntregar, FechaEntregaTotal, DiasDeAtraso From DetallePedidosProveedores Where Documento = '" & VNumeroPedido & "' And Codigo = '" & VCodigo & "'")
                    If RBuscaPedido.RecordCount > 0 Then
                        ...
                        RBuscaPedido.Edit
                            ...
                            Else
                                ...
                                Else
                                    RBuscaPedido!FechaEntregaTotal = "01/01/1900"
        ...
        ElseIf Index = 6 Then 'SELECCIONAR DATOS
                    ...
                    If OptBusqueda.Item(0).Value = True Then
                        DataCerrarPedidos.RecordSource = ("Select * From CerrarPedidoProveedores where Documento = '" & TxtBusqueda.Text & "' Order By FechaRecepcion")
                    'FECHAS
                    ElseIf OptBusqueda.Item(1).Value = True Then
                        DataCerrarPedidos.RecordSource = ("Select * From CerrarPedidoProveedores where FechaRecepcion >= #" & Format(DtpFecIni.Value, "mm/dd/yyyy") & "# And FechaRecepcion <= #" & Format(DtpFecFin.Value, "mm/dd/yyyy") & "# Order By FechaRecepcion")
                    'PEDIDO
                    ElseIf OptBusqueda.Item(1).Value = True Then
                        DataCerrarPedidos.RecordSource = ("Select * From CerrarPedidoProveedores where Pedido = '" & TxtBusqueda.Text & "' Order By FechaRecepcion")
                    End If
                    DataCerrarPedidos.Refresh
                    DGridCerrarPedidos.Refresh
                    TabDepartamentos.Tab = 1
        ElseIf Index = 7 Then 'ACTUALIZAR
                    DataCerrarPedidos.RecordSource = "Select * From CerrarPedidoProveedores Order By FechaRecepcion"
                    DataCerrarPedidos.Refresh
                    DGridCerrarPedidos.Refresh
                    TabDepartamentos.Tab = 1
        End If
...
'BUSCA EL ENCABEZADO DE PEDIDO
        Set RBuscaSaldoEncabezado = Db.OpenRecordset("Select EP.Fecha, P.Proveedor, EP.Observaciones From EncabezadoPedidosProveedores as EP, Proveedores as P Where EP.Documento = '" & TxtTexto.Item(2).Text & "' And EP.Proveedor = P.CodigoProveedor")
                   If RBuscaSaldoEncabezado.RecordCount > 0 Then
                       TxtDatos.Text = ""
                       ...
                       Set RBuscaSaldoDetalle = Db.OpenRecordset("Select * From DetallePedidosProveedores Where Documento = '" & TxtTexto.Item(2).Text & "' And Codigo = '" & TxtTexto.Item(1).Text & "'")
        ...
        Set RBuscaCierrePedidos = Db.OpenRecordset("Select Documento, FechaOperacion, FechaRecepcion, Cantidad From CerrarPedidoProveedores Where Pedido = '" & TxtTexto.Item(2).Text & "' And Codigo = '" & TxtTexto.Item(1).Text & "'")
            If RBuscaCierrePedidos.RecordCount > 0 Then
                    TxtDatos2.Text = ""
                    TxtDatos2.Text = TxtDatos2.Text & "Documento      Fecha Operacion     Fecha Recepcion             Cantidad" & vbCrLf
...
Private Sub DGridCerrarPedidos_HeadClick(ByVal ColIndex As Integer)
        DataCerrarPedidos.RecordSource = "Select * from CerrarPedidoProveedores Order by " & DGridCerrarPedidos.Columns(ColIndex).DataField
        DataCerrarPedidos.Refresh
        DGridCerrarPedidos.Refresh
End Sub
...
Private Sub TxtTexto_DblClick(Index As Integer)
    ...
    ElseIf Index = 2 Then
        DataBusqueda.RecordSource = "Select P.Fecha, P.Documento, DP.CantidadPedido, DP.CantidadEntregada, DP.SaldoPorEntregar, Pr.Proveedor From EncabezadoPedidosProveedores As P, Proveedores as Pr, DetallePedidosProveedores as DP Where DP.Codigo = '" & TxtTexto.Item(1).Text & "' And DP.SaldoPorEntregar > 0 And P.Documento = DP.Documento And P.Proveedor = Pr.CodigoProveedor Order By Fecha"
        BMateriaPrima = False
        BPedido = True
    End If
        DataBusqueda.Refresh
