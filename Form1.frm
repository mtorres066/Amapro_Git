...
MousePointer = 11
    ...
    Do Until RVariablesDescripcion.EOF
            RVariablesDescripcion2.AddNew
                ...
                RVariablesDescripcion2(2) = RVariablesDescripcion(2)
    ...
    Loop
        MsgBox "Variables Descripcion Listo"
    ...
    Loop
        MsgBox "Ficha Tecnica Listo"
        
    'CORRELATIVOS MATERIA PRIMA
    Set RCorrelativosMateriaPrima = Db.OpenRecordset("Select * From CorrelativosMateriaPrima")
    Set RCorrelativosMateriaPrima2 = Db.OpenRecordset("Select * From CorrelativosMateriaPrima")
    ...
    Do Until RCorrelativosMateriaPrima.EOF
            RCorrelativosMateriaPrima2.AddNew
                ...
                RCorrelativosMateriaPrima2!TipoDeMateriaPrima = RCorrelativosMateriaPrima!TipoMateriaPrima
    ...
    Loop
        MsgBox "Correlativos Materia Prima Listo"
        

    'LINEAS
    Set RLineas = Db.OpenRecordset("Select * From Lineas")
    Set RLineas2 = Db.OpenRecordset("Select * From Lineas")
    ...
    Set RRutinas2 = Db.OpenRecordset("Select * From Rutinas")
    ...
    Do Until RRutinas.EOF
        ...
        RRutinas.MoveNext
    Loop
        MsgBox "Rutinas Listo"
    
    'BATCH
    Set RBatch = Db.OpenRecordset("Select * From Batch")
    Set RBatch2 = Db.OpenRecordset("Select * From Batch")
    ...
    Set RBatchDatos2 = Db.OpenRecordset("Select * From BatchDatos")
    
    Do Until RBatchDatos.EOF
            RBatchDatos2.AddNew
                RBatchDatos2!Batch = RBatchDatos!Batch
                RBatchDatos2!Rutina = RBatchDatos!Rutina
                RBatchDatos2!LIM_Pro_IN = RBatchDatos!Lim_Pro_Inf
    ...
    Loop
        MsgBox "Batch Datos Listo"
        
    'CAPTURA DE RUTINAS
    Set RCapturaRutinas = Db.OpenRecordset("Select * From CapturaRutinas")
    Set RCapturaRutinas2 = Db.OpenRecordset("Select * From CapturaRutinas")
    ...
    Loop
        MsgBox "CAPTURA RUTINAS Listo"
        
    'DEFECTOS
    Set RDefectos = Db.OpenRecordset("Select * From Defectos")
    Set RDefectos2 = Db.OpenRecordset("Select * From Defectos")
    ...
    Do Until RDefectos.EOF
        ...
        RDefectos.MoveNext
    Loop
        MsgBox "Defectos Listo"

    'PROVEEDORES
    Set RProveedores = Db.OpenRecordset("Select * From Proveedores")
    Set RProveedores2 = Db.OpenRecordset("Select * From Proveedores")
    ...
    Loop
        MsgBox "Produccion Listo"

    'PRODUCCION CON MATERIA PRIMA (fondo)
    Set RProduccionConMateriaPrima = Db.OpenRecordset("Select * From Produccion")
    Set RProduccionConMateriaPrima2 = Db.OpenRecordset("Select * From ProduccionConMateriaPrima")
    ...
    Loop
        MsgBox "Produccion Con Materia Prima Listo (fondo"
    ...
    Do Until RProduccionConMateriaPrima.EOF
        ...
        RProduccionConMateriaPrima.MoveNext
    Loop
        MsgBox "Produccion Con Materia Prima Listo (hojalata)"
    ...
    Do Until RProduccionConMateriaPrima.EOF
        ...
        RProduccionConMateriaPrima.MoveNext
    Loop
        MsgBox "Produccion Con Materia Prima Listo (Alambre"
    ...
    Do Until RProduccionConMateriaPrima.EOF
        ...
        RProduccionConMateriaPrima.MoveNext
    Loop
        MsgBox "Produccion Con Materia Prima Listo (barniz liquido"
    ...
    Do Until RProduccionConMateriaPrima.EOF
        ...
        RProduccionConMateriaPrima.MoveNext
    Loop
        MsgBox "Produccion Con Materia Prima Listo (sello solve"
    ...
    Do Until RProduccionConMateriaPrima.EOF
        ...
        RProduccionConMateriaPrima.MoveNext
    Loop
        MsgBox "Produccion Con Materia Prima Listo (barniz p"
    ...
    Do Until RProduccionConMateriaPrima.EOF
        ...
        RProduccionConMateriaPrima.MoveNext
    Loop
        MsgBox "Produccion Con Materia Prima Listo (nylon"
    ...
    Do Until RProduccionConMateriaPrima.EOF
        ...
        RProduccionConMateriaPrima.MoveNext
    Loop
        MsgBox "Produccion Con Materia Prima Listo (BOBINA"
...
'PRODUCCION CON DEFECTOS (DEFECTO1
    ...
    Set RProduccionConDefectos2 = Db.OpenRecordset("Select * From ProduccionConDefectos")
    
    Do Until RProduccionConDefectos.EOF
            RProduccionConDefectos2.AddNew
                RProduccionConDefectos2!Fec_Prd = RProduccionConMateriaPrima!Fec_Prd
                RProduccionConDefectos2!Linea = RProduccionConMateriaPrima!Linea
                RProduccionConDefectos2!Esp_Tec = RProduccionConMateriaPrima!Esp_Tec
                RProduccionConDefectos2!Tarima = RProduccionConMateriaPrima!Tarima
                RProduccionConDefectos2!Defecto = RProduccionConMateriaPrima!Defecto1
                RProduccionConDefectos2!Cantidad = RProduccionConMateriaPrima!Cantidad1
    ...
    Loop
        MsgBox "Produccion Con DEFECTOS"
    ...
    Do Until RProduccionConDefectos.EOF
            RProduccionConDefectos2.AddNew
                ...
                RProduccionConDefectos2!Esp_Tec = RProduccionConMateriaPrima!Esp_Tec
                RProduccionConDefectos2!Tarima = RProduccionConMateriaPrima!Tarima
                RProduccionConDefectos2!Defecto = RProduccionConMateriaPrima!Defecto2
                RProduccionConDefectos2!Cantidad = RProduccionConMateriaPrima!Cantidad2
            RProduccionConDefectos2.Update
            If Err.Number <> 0 Then
                MsgBox Err.Number & " " & Err.Description
            End If
    ...
    'PRODUCCION CON DEFECTOS (DEFECTO3
    Set RProduccionConDefectos = Db.OpenRecordset("Select * From Produccion")
    Set RProduccionConDefectos2 = Db.OpenRecordset("Select * From ProduccionConDefectos")
    ...
    Do Until RProduccionConDefectos.EOF
            RProduccionConDefectos2.AddNew
                ...
                RProduccionConDefectos2!Esp_Tec = RProduccionConMateriaPrima!Esp_Tec
                RProduccionConDefectos2!Tarima = RProduccionConMateriaPrima!Tarima
                RProduccionConDefectos2!Defecto = RProduccionConMateriaPrima!Defecto3
                RProduccionConDefectos2!Cantidad = RProduccionConMateriaPrima!Cantidad3
            RProduccionConDefectos2.Update
            If Err.Number <> 0 Then
                MsgBox Err.Number & " " & Err.Description
            End If
    ...
    'PRODUCCION CON DEFECTOS (DEFECTO4
    Set RProduccionConDefectos = Db.OpenRecordset("Select * From Produccion")
    Set RProduccionConDefectos2 = Db.OpenRecordset("Select * From ProduccionConDefectos")
    ...
    Do Until RProduccionConDefectos.EOF
            RProduccionConDefectos2.AddNew
                ...
                RProduccionConDefectos2!Esp_Tec = RProduccionConMateriaPrima!Esp_Tec
                RProduccionConDefectos2!Tarima = RProduccionConMateriaPrima!Tarima
                RProduccionConDefectos2!Defecto = RProduccionConMateriaPrima!Defecto4
                RProduccionConDefectos2!Cantidad = RProduccionConMateriaPrima!Cantidad4
            RProduccionConDefectos2.Update
            If Err.Number <> 0 Then
                MsgBox Err.Number & " " & Err.Description
            End If
    ...
    Set RProduccionLiberada2 = Db.OpenRecordset("Select * From ProduccionLiberada")
    ...
    Set RProduccionLiberadaConTarima2 = Db.OpenRecordset("Select * From ProduccionLiberadaConTarimas")
    ...
    Do Until RProduccionLiberadaConTarima.EOF
        ...
        RProduccionLiberadaConTarima.MoveNext
    Loop
        MsgBox "Produccion LIBERADA COMPLEMENTO"
    ...
    Set RProduccionLiberadaConDefectos2 = Db.OpenRecordset("Select * From ProduccionLiberadaConDefectos")
    ...
    Loop
        MsgBox "Produccion LIBERADA CON DEFECTOS"
...
'PRODUCCION LIBERADA CON DEFECTOS
    ...
    Do Until RBultos.EOF
        ...
        RBultos.MoveNext
    Loop
        MsgBox "BULTOS PROCESADOS LISTO"
    ...
    Set RTraslados2 = Db2.OpenRecordset("Select * From EncabezadoTrasladoMateriaPrimaP")
    ...
    Do Until RTraslados.EOF
        ...
        RTraslados.MoveNext
    Loop
        MsgBox "Traslados Listo"
    
    
    
    'DETALLE DE TRASLADOS
    Set RTrasladosDetalle = Db.OpenRecordset("Select * From DetalleTrasladosMateriaPrimaP")
    Set RTrasladosDetalle2 = Db2.OpenRecordset("Select * From DetalleTrasladoMateriaPrimaP")
    ...
    Loop
        MsgBox "Traslados DETALLE Listo"
    ...
    Do Until REntradasDetalle.EOF
            REntradasDetalle2.AddNew
                ...
                REntradasDetalle2!Calidad = REntradasDetalle!Calidad
                ...
                REntradasDetalle2!Estado = REntradasDetalle!Estado
