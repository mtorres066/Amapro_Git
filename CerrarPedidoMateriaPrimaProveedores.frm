...
Begin VB.Form CerrarPedidoMateriaPrimaProveedores 
   BackColor       =   &H00008000&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Cerrar Pedidos De Materia Prima De Proveedores"
   ClientHeight    =   6345
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9315
   Icon            =   "CerrarPedidoMateriaPrimaProveedores.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6345
   ...
   Begin VB.Frame FrameBusqueda 
      ...
      Begin VB.CommandButton CmdSale 
         Height          =   615
         Left            =   8160
         Picture         =   "CerrarPedidoMateriaPrimaProveedores.frx":08CA
         Style           =   1  'Graphical
         TabIndex        =   30
      ...
      Begin MSDBGrid.DBGrid DBGridBusqueda 
         Bindings        =   "CerrarPedidoMateriaPrimaProveedores.frx":293C
         Height          =   5775
         Left            =   120
         OleObjectBlob   =   "CerrarPedidoMateriaPrimaProveedores.frx":2957
         TabIndex        =   29
   ...
   Begin TabDlg.SSTab TabDepartamentos 
      ...
      TabPicture(0)   =   "CerrarPedidoMateriaPrimaProveedores.frx":3331
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "FrameCerrarPedidos"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Vista General"
      TabPicture(1)   =   "CerrarPedidoMateriaPrimaProveedores.frx":364B
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "DGridCerrarPedidos"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "Busqueda"
      TabPicture(2)   =   "CerrarPedidoMateriaPrimaProveedores.frx":3A9D
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "FrameBusquedadeDatos"
      Tab(2).ControlCount=   1
      Begin MSDBGrid.DBGrid DGridCerrarPedidos 
         Bindings        =   "CerrarPedidoMateriaPrimaProveedores.frx":3EEF
         Height          =   3975
         Left            =   -74880
         OleObjectBlob   =   "CerrarPedidoMateriaPrimaProveedores.frx":3F0F
         TabIndex        =   13
      ...
      Begin VB.Frame FrameBusquedadeDatos 
         ...
         Begin VB.OptionButton OptBusqueda 
            ...
            Index           =   2
            Left            =   3000
            Picture         =   "CerrarPedidoMateriaPrimaProveedores.frx":533D
            Style           =   1  'Graphical
            TabIndex        =   8
            Top             =   360
            Width           =   1335
         ...
         Begin VB.OptionButton OptBusqueda 
            ...
            Index           =   1
            Left            =   1560
            Picture         =   "CerrarPedidoMateriaPrimaProveedores.frx":5647
            Style           =   1  'Graphical
            TabIndex        =   16
            Top             =   360
            Width           =   1335
         ...
         Begin VB.OptionButton OptBusqueda 
            ...
            Index           =   0
            Left            =   120
            Picture         =   "CerrarPedidoMateriaPrimaProveedores.frx":84C1
            Style           =   1  'Graphical
            TabIndex        =   15
            Top             =   360
            Value           =   -1  'True
         ...
         Begin MSForms.CommandButton CmdBotones 
            ...
            Size            =   "4471;1085"
            Picture         =   "CerrarPedidoMateriaPrimaProveedores.frx":DAC3
   ...
   End
End
Attribute VB_Name = "CerrarPedidoMateriaPrimaProveedores"
...
On Error Resume Next
    With DataCerrarPedidos.Recordset
        ...
        ElseIf Index = 2 Then
                ...
                Set RBuscaPedido2 = Db.OpenRecordset("Select * From PedidosMateriaPrimaProveedores Where Documento = '" & Txttexto.Item(2).Text & "'")
                ...
                Set RBuscaPedido3 = Db.OpenRecordset("Select * From PedidosMateriaPrimaProveedores Where Documento = '" & Txttexto.Item(2).Text & "' And Codigo = '" & Txttexto.Item(1).Text & "'")
                ...
                Set RBuscaSaldo = Db.OpenRecordset("Select SaldoPorEntregar From PedidosMateriaPrimaProveedores Where Documento = '" & Txttexto.Item(2).Text & "' And Codigo = '" & Txttexto.Item(1).Text & "'")
                ...
                '________________________________________________________________________________________________________
                            ...
                            Set RBuscaPedido = Db.OpenRecordset("Select Sum(Cantidad) From CerrarPedidoMateriaPrimaProveedores Where Documento = '" & Txttexto.Item(0).Text & "' And CodigoMateriaPrima = '" & Txttexto.Item(1).Text & "'")
                ...
                Set RBuscaPedido = Db.OpenRecordset("Select CantidadEntregada, SaldoPorEntregar, FechaParaEntregar, FechaEntregaTotal, DiasDeAtraso From PedidosMateriaPrimaProveedores Where Documento = '" & VNumeroPedido & "' And Codigo = '" & VCodigo & "'")
                    If RBuscaPedido.RecordCount > 0 Then
        ...
        ElseIf Index = 6 Then 'SELECCIONAR DATOS
                    ...
                    If OptBusqueda.Item(0).Value = True Then
                        DataCerrarPedidos.RecordSource = ("Select * From CerrarPedidoMateriaPrimaProveedores where Documento = '" & TxtBusqueda.Text & "' Order By FechaRecepcion")
                    'FECHAS
                    ElseIf OptBusqueda.Item(1).Value = True Then
                        DataCerrarPedidos.RecordSource = ("Select * From CerrarPedidoMateriaPrimaProveedores where FechaRecepcion >= #" & Format(DtpFecIni.Value, "mm/dd/yyyy") & "# And FechaRecepcion <= #" & Format(DtpFecFin.Value, "mm/dd/yyyy") & "# Order By FechaRecepcion")
                    'PEDIDO
                    ElseIf OptBusqueda.Item(1).Value = True Then
                        DataCerrarPedidos.RecordSource = ("Select * From CerrarPedidoMateriaPrimaProveedores where Pedido = '" & TxtBusqueda.Text & "' Order By FechaRecepcion")
                    End If
                    DataCerrarPedidos.Refresh
                    DGridCerrarPedidos.Refresh
                    TabDepartamentos.Tab = 1
        ElseIf Index = 7 Then 'ACTUALIZAR
                    DataCerrarPedidos.RecordSource = "Select * From CerrarPedidoMateriaPrimaProveedores Order By FechaRecepcion"
                    DataCerrarPedidos.Refresh
                    DGridCerrarPedidos.Refresh
                    TabDepartamentos.Tab = 1
        End If
...
Private Sub DGridCerrarPedidos_HeadClick(ByVal ColIndex As Integer)
        DataCerrarPedidos.RecordSource = "Select * from CerrarPedidoMateriaPrimaProveedores Order by " & DGridCerrarPedidos.Columns(ColIndex).DataField
        DataCerrarPedidos.Refresh
        DGridCerrarPedidos.Refresh
End Sub
...
Private Sub TxtTexto_DblClick(Index As Integer)
    ...
    ElseIf Index = 2 Then
        DataBusqueda.RecordSource = "Select P.FechaPedido, P.Documento, P.CantidadPedido, P.CantidadEntregada, P.SaldoPorEntregar, Pr.Proveedor From PedidosMateriaPrimaProveedores As P, Proveedores as Pr Where P.Codigo = '" & Txttexto.Item(1).Text & "' And P.SaldoPorEntregar > 0 And P.Proveedor = Pr.CodigoProveedor"
        BMateriaPrima = False
        BPedido = True
    End If
...
Private Sub TxtTexto_LostFocus(Index As Integer)
        ...
        If Index = 0 Then
                Set RBuscaRecepcion = Db.OpenRecordset("Select FechaEntrada From EncabezadoEntradasMateriaPrima Where Documento = '" & Txttexto.Item(0).Text & "'")
                    If RBuscaRecepcion.RecordCount > 0 Then
                            MskFecRec.Text = RBuscaRecepcion!FechaEntrada
                    End If
        End If
        ...
        If Index = 1 Then
                'BUSCA LA CANTIDAD QUE TRAE LA RECEPCION
                Set RBuscaCantidadRecepcion = Db.OpenRecordset("Select Sum(Cantidad) From DetalleEntradasMateriaPrima Where Documento = '" & Txttexto.Item(0).Text & "' And Codigo = '" & Txttexto.Item(1).Text & "'")
                    If RBuscaCantidadRecepcion.RecordCount > 0 Then
                        If IsNull(RBuscaCantidadRecepcion(0)) Then
                            VCantidadEntrada = 0
                        Else
                            VCantidadEntrada = RBuscaCantidadRecepcion(0)
                        End If
                    Else
                        VCantidadEntrada = 0
                    End If
                ...
                'BUSCA LA CANTIDAD QUE TIENE EL CIERRE DE PEDIDOS
                Set RBuscaCantidadPedido = Db.OpenRecordset("Select Sum(Cantidad) From CerrarPedidoMateriaPrimaProveedores Where Documento = '" & Txttexto.Item(0).Text & "' And CodigoMateriaPrima = '" & Txttexto.Item(1).Text & "'")
                ...
                MskCan.Text = Val(VCantidadEntrada) - Val(VCantidadCerrarPedido)
        End If
