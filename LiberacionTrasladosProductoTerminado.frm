...
Begin VB.Form LiberacionTrasladosProductoTerminado 
   BackColor       =   &H00C00000&
   Caption         =   $"LiberacionTrasladosProductoTerminado.frx":0000
   ClientHeight    =   7590
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11880
   Icon            =   "LiberacionTrasladosProductoTerminado.frx":0092
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   7590
   ScaleWidth      =   11880
   ...
   Begin VB.CommandButton Command2 
      ...
      Height          =   975
      Left            =   10080
      Picture         =   "LiberacionTrasladosProductoTerminado.frx":039C
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   1200
      Width           =   1695
   ...
   Begin VB.CommandButton CmdLiberar 
      ...
      Height          =   975
      Left            =   10080
      Picture         =   "LiberacionTrasladosProductoTerminado.frx":240E
      Style           =   1  'Graphical
      TabIndex        =   1
      Top             =   120
      Width           =   1695
   ...
   End
End
Attribute VB_Name = "LiberacionTrasladosProductoTerminado"
...
Private Sub CmdLiberar_Click()
                                    ...
                                    Set RBuscaDetalleTraslados = New ADODB.Recordset
                                        Call Abrir_Recordset(RBuscaDetalleTraslados, "Select FichaTecnica, Tarima, FechaProduccion, Linea From DetalleTrasladosInventario Where Documento = " & TxtDoc.Text)
                                            ...
                                            If RBuscaDetalleTraslados.RecordCount > 0 Then
                                                ...
                                                Conexion.BeginTrans
                                                    ...
                                                    Do Until RBuscaDetalleTraslados.EOF
                                                            ...
                                                            VLinea = RBuscaDetalleTraslados!Linea
                                                    
                                                            'BUSCA TARIMA EN INVENTARIO (ENTRADAS PT) Y MODIFICA LA BODEGA
                                                            If GOrigenDeDatos = "AmaproAccess" Then
                                                                Conexion.Execute ("update DetalleEntradasInventario set bodega = '" & RBuscaDetalleTraslados!BodegaEntrada & "' Where FichaTecnica = '" & VFichaTecnica & "' And Tarima = " & VTarima & " And FechaProduccion = #" & Format(VFechaProduccion, "mm/dd/yyyy") & "# And Linea = '" & VLinea & "'")
                                                            Else
                                                                Conexion.Execute ("update DetalleEntradasInventario set bodega = '" & UCase(RBuscaDetalleTraslados!BodegaEntrada) & "' Where UPPER(FichaTecnica) = '" & UCase(VFichaTecnica) & "' And Tarima = " & VTarima & " And FechaProduccion = To_Date('" & VFechaProduccion & "', 'dd/mm/yyyy')" & " And UPPER(Linea) = '" & UCase(VLinea) & "'")
                                                            End If
...
On Error Resume Next
    If IsNumeric(TxtDoc.Text) Then
            Set RDatos = New ADODB.Recordset
                If GOrigenDeDatos = "AmaproAccess" Then
                    Call Abrir_Recordset(RDatos, "Select DD.Bodega, DD.FichaTecnica, FT.Descrip, DD.Cantidad, DD.Tarima, DD.FechaProduccion, DD.Linea, DD.Calidad, DD.Batch From DetalleEntradasInventario DD, FichaTecnica FT Where DD.FichaTecnica = FT.Esp_Tec And DD.Documento = " & TxtDoc.Text & " Order By DD.FechaProduccion, DD.Linea, DD.Tarima")
                Else
                    Call Abrir_Recordset(RDatos, "Select DD.Bodega, DD.FichaTecnica, FT.Descrip, DD.Cantidad, DD.Tarima, DD.FechaProduccion, DD.Linea, DD.Calidad, DD.Batch From DetalleEntradasInventario DD, FichaTecnica FT Where UPPER(DD.FichaTecnica) = UPPER(FT.Esp_Tec) And DD.Documento = " & TxtDoc.Text & " Order By DD.FechaProduccion, DD.Linea, DD.Tarima")
                End If
            ...
            Call Abrir_Recordset(RBuscaEncabezadoTraslados, "Select Fecha, Requerido, Observaciones, BodegaaSalida From EncabezadoTrasladosInventario Where Documento = " & TxtDoc.Text)
