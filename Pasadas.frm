...
Begin VB.Form Pasadas 
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   1
      Left            =   120
      MouseIcon       =   "Pasadas.frx":0442
      Picture         =   "Pasadas.frx":0884
      Style           =   1  'Graphical
      TabIndex        =   25
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   2
      Left            =   480
      MouseIcon       =   "Pasadas.frx":0DB6
      Picture         =   "Pasadas.frx":11F8
      Style           =   1  'Graphical
      TabIndex        =   24
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   3
      Left            =   7440
      MouseIcon       =   "Pasadas.frx":172A
      Picture         =   "Pasadas.frx":1B6C
      Style           =   1  'Graphical
      TabIndex        =   23
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   4
      Left            =   7800
      MouseIcon       =   "Pasadas.frx":209E
      Picture         =   "Pasadas.frx":24E0
      Style           =   1  'Graphical
      TabIndex        =   22
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   5
      Left            =   6360
      MouseIcon       =   "Pasadas.frx":3D1C
      Picture         =   "Pasadas.frx":415E
      Style           =   1  'Graphical
      TabIndex        =   8
      Top             =   4320
      Width           =   1000
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   4
      Left            =   5280
      MouseIcon       =   "Pasadas.frx":61D0
      Picture         =   "Pasadas.frx":6612
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   4320
      Width           =   1000
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   3
      Left            =   4200
      MouseIcon       =   "Pasadas.frx":6B44
      Picture         =   "Pasadas.frx":6F86
      Style           =   1  'Graphical
      TabIndex        =   6
      Top             =   4320
      Width           =   1000
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   2
      Left            =   3120
      MouseIcon       =   "Pasadas.frx":74B8
      Picture         =   "Pasadas.frx":78FA
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   4320
      Width           =   1000
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   1
      Left            =   2040
      MouseIcon       =   "Pasadas.frx":7E2C
      Picture         =   "Pasadas.frx":826E
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   4320
      Width           =   1000
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   0
      Left            =   960
      MouseIcon       =   "Pasadas.frx":87A0
      Picture         =   "Pasadas.frx":8BE2
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   4320
      Width           =   1000
    ...
    On Error Resume Next
            ...
            ElseIf Index = 2 Then
                    If BEditar = False Then 'ESTA AGREGANDO UN REGISTRO
                         Conexion.Execute "Insert Into Pasadas Values('" & TxtTexto.Item(0).Text & "', '" & TxtTexto.Item(1).Text & "', '" & TxtTexto.Item(2).Text & "')"
                    Else 'ESTA EDITANDO UN REGISTRO
                         Conexion.Execute "UPDATE Pasadas SET Descripcion = '" & TxtTexto.Item(1).Text & "', Usuario = '" & TxtTexto.Item(2).Text & "' Where Codigo = '" & TxtTexto.Item(0).Text & "'"
                    End If
                    
                    'SI SE DUPLICA LA LLAVE
                     If GOrigenDeDatos = "AmaproAccess" Then
                        If Err = -2147467259 Then
                            MsgBox "Codigo De Pasada Ya Existe", vbOKOnly + vbInformation, "Informacion"
                            TxtTexto.Item(0).SetFocus
                            Exit Sub
...
MousePointer = 11
    ...
    If RPasadas.BOF Then
        RPasadas.MoveFirst
    ElseIf RPasadas.EOF Then
        RPasadas.MoveLast
    End If
...
Private Sub CmdBuscar_Click(Index As Integer)
        ...
        If Index = 0 Then
            If OptCodigo.Value = True Then
                If GOrigenDeDatos = "AmaproAccess" Then
                    Call Abrir_Recordset(RPasadas, "Select * from Pasadas where Codigo Like '%" & TxtBuscar.Text & "%'")
                Else 'ORACLE
                    Call Abrir_Recordset(RPasadas, "Select * from Pasadas where UPPER(Codigo) Like '%" & UCase(TxtBuscar.Text) & "%'")
                End If
            ElseIf OptDescripcion.Value = True Then
                If GOrigenDeDatos = "AmaproAccess" Then
                    Call Abrir_Recordset(RPasadas, "Select * from Pasadas where Descripcion Like '%" & TxtBuscar.Text & "%'")
                Else 'ORACLE
                    Call Abrir_Recordset(RPasadas, "Select * from Pasadas where UPPER(Descripcion) Like '%" & UCase(TxtBuscar.Text) & "%'")
                End If
            End If
        ...
        Set DataGrid1.DataSource = RPasadas
...
On Error Resume Next
                RPasadas.Sort = RPasadas.Fields(ColIndex).Name
...
On Error Resume Next
        TxtTexto.Item(0).Text = RPasadas!Codigo
        TxtTexto.Item(1).Text = RPasadas!Descripcion
        TxtTexto.Item(2).Text = RPasadas!Usuario
        If Err <> 0 Then
        End If
End Sub
