...
Begin VB.Form EmpleadosCapturaAumentos 
   BackColor       =   &H0080C0FF&
   ...
   ClientTop       =   345
   ClientWidth     =   8415
   Icon            =   "EmpleadosCapturaAumentos.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   4710
   ...
   Begin VB.Frame FrameBusqueda 
      ...
      Begin VB.CommandButton CmdSale 
         Height          =   735
         Left            =   7440
         Picture         =   "EmpleadosCapturaAumentos.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   22
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   4
      Left            =   7800
      MouseIcon       =   "EmpleadosCapturaAumentos.frx":237C
      Picture         =   "EmpleadosCapturaAumentos.frx":27BE
      Style           =   1  'Graphical
      TabIndex        =   27
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   3
      Left            =   7440
      MouseIcon       =   "EmpleadosCapturaAumentos.frx":2CF0
      Picture         =   "EmpleadosCapturaAumentos.frx":3132
      Style           =   1  'Graphical
      TabIndex        =   26
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   2
      Left            =   480
      MouseIcon       =   "EmpleadosCapturaAumentos.frx":3664
      Picture         =   "EmpleadosCapturaAumentos.frx":3AA6
      Style           =   1  'Graphical
      TabIndex        =   25
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   1
      Left            =   120
      MouseIcon       =   "EmpleadosCapturaAumentos.frx":3FD8
      Picture         =   "EmpleadosCapturaAumentos.frx":441A
      Style           =   1  'Graphical
      TabIndex        =   24
   ...
   Begin TabDlg.SSTab TabBodegas 
      ...
      TabPicture(0)   =   "EmpleadosCapturaAumentos.frx":494C
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "FrameBodegas"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Vista General"
      TabPicture(1)   =   "EmpleadosCapturaAumentos.frx":4C66
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "DataGrid1"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "Busqueda De Datos"
      TabPicture(2)   =   "EmpleadosCapturaAumentos.frx":50B8
      ...
      Begin VB.Frame FrameOpciones 
         ...
         Begin VB.CommandButton CmdBuscar 
            ...
            Index           =   0
            Left            =   6120
            Picture         =   "EmpleadosCapturaAumentos.frx":550A
            Style           =   1  'Graphical
            TabIndex        =   29
            Top             =   960
            Width           =   1812
         ...
         Begin VB.CommandButton CmdBuscar 
            ...
            Index           =   1
            Left            =   6120
            Picture         =   "EmpleadosCapturaAumentos.frx":7204
            Style           =   1  'Graphical
            TabIndex        =   30
            Top             =   1800
            Width           =   1812
   ...
   Begin VB.CommandButton CmdSalida 
      ...
      Height          =   800
      Left            =   6240
      MouseIcon       =   "EmpleadosCapturaAumentos.frx":750E
      Picture         =   "EmpleadosCapturaAumentos.frx":7950
      Style           =   1  'Graphical
      TabIndex        =   8
      Top             =   3840
      Width           =   1065
   ...
   Begin VB.CommandButton CmdBorrar 
      ...
      Height          =   800
      Left            =   4920
      MouseIcon       =   "EmpleadosCapturaAumentos.frx":99C2
      Picture         =   "EmpleadosCapturaAumentos.frx":9E04
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   3840
      Width           =   1200
   ...
   Begin VB.CommandButton CmdCancelar 
      ...
      Height          =   800
      Left            =   3600
      MouseIcon       =   "EmpleadosCapturaAumentos.frx":A336
      Picture         =   "EmpleadosCapturaAumentos.frx":A778
      Style           =   1  'Graphical
      TabIndex        =   6
      Top             =   3840
      Width           =   1200
   ...
   Begin VB.CommandButton CmdGrabar 
      ...
      Height          =   800
      Left            =   2280
      MouseIcon       =   "EmpleadosCapturaAumentos.frx":ACAA
      Picture         =   "EmpleadosCapturaAumentos.frx":B0EC
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   3840
      Width           =   1200
   ...
   Begin VB.CommandButton CmdAgregar 
      ...
      Height          =   800
      Left            =   960
      MouseIcon       =   "EmpleadosCapturaAumentos.frx":B61E
      Picture         =   "EmpleadosCapturaAumentos.frx":BA60
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   3840
      Width           =   1200
   End
End
Attribute VB_Name = "EmpleadosCapturaAumentos"
...
Dim RAumentos As New ADODB.Recordset
...
MousePointer = 11
    ...
    If RAumentos.BOF Then
        RAumentos.MoveFirst
    ElseIf RAumentos.EOF Then
        RAumentos.MoveLast
    End If
...
Private Sub CmdBuscar_Click(Index As Integer)
    ...
    'INICIALIZAMOS EL RECORDSET
        Set RAumentos = New ADODB.Recordset
        
    If Index = 0 Then
            If GOrigenDeDatos = "AmaproAccess" Then
                Call Abrir_Recordset(RAumentos, "Select * from EmpleadosCapturaAumentos where Empleado like '" & TxtBuscar.Text & "%'")
            Else
                Call Abrir_Recordset(RAumentos, "Select * from EmpleadosCapturaAumentos where UPPER(Empleado) like '" & UCase(TxtBuscar.Text) & "%'")
            End If
    ElseIf Index = 1 Then
            Call Abrir_Recordset(RAumentos, "Select * from EmpleadosCapturaAumentos")
    End If
        Set DataGrid1.DataSource = RAumentos
        TabBodegas.Tab = 1
...
On Error Resume Next
                    ...
                    Set RBuscaEmpleado = New ADODB.Recordset
                        ...
                        End If
                            ...
                            End If
                            VTexto = VTexto & MskMon.Text & ", '" 'DIRECCION
                            VTexto = VTexto & TxtTexto.Item(6).Text & "')" 'USUARIO
                            
                            Conexion.Execute "Insert Into EmpleadosCapturaAumentos " & VTexto
...
Private Sub DataGrid1_HeadClick(ByVal ColIndex As Integer)
    On Error Resume Next
                RAumentos.Sort = RAumentos.Fields(ColIndex).Name
...
On Error Resume Next
        ...
        TxtTexto.Item(0).Text = RAumentos!Empleado
        MskFec.Text = RAumentos!fecha
        MskMon.Text = RAumentos!Monto
        TxtTexto.Item(6).Text = RAumentos!Usuario
