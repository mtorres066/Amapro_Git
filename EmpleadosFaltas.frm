...
Begin VB.Form EmpleadosFaltas 
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   1
      Left            =   120
      MouseIcon       =   "EmpleadosFaltas.frx":0442
      Picture         =   "EmpleadosFaltas.frx":0884
      Style           =   1  'Graphical
      TabIndex        =   25
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   2
      Left            =   480
      MouseIcon       =   "EmpleadosFaltas.frx":0DB6
      Picture         =   "EmpleadosFaltas.frx":11F8
      Style           =   1  'Graphical
      TabIndex        =   24
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   3
      Left            =   7440
      MouseIcon       =   "EmpleadosFaltas.frx":172A
      Picture         =   "EmpleadosFaltas.frx":1B6C
      Style           =   1  'Graphical
      TabIndex        =   23
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   4
      Left            =   7800
      MouseIcon       =   "EmpleadosFaltas.frx":209E
      Picture         =   "EmpleadosFaltas.frx":24E0
      Style           =   1  'Graphical
      TabIndex        =   22
   ...
   Begin TabDlg.SSTab TabPuestos 
      ...
      TabPicture(0)   =   "EmpleadosFaltas.frx":2A12
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "FramePuestos"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Vista General"
      TabPicture(1)   =   "EmpleadosFaltas.frx":2D2C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "DataGrid1"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "Busqueda De Datos"
      TabPicture(2)   =   "EmpleadosFaltas.frx":317E
      ...
      Begin VB.CommandButton CmdBuscar 
         ...
         Index           =   1
         Left            =   -68760
         Picture         =   "EmpleadosFaltas.frx":35D0
         Style           =   1  'Graphical
         TabIndex        =   21
         Top             =   3240
         Width           =   2055
      ...
      Begin VB.CommandButton CmdBuscar 
         ...
         Index           =   0
         Left            =   -68760
         Picture         =   "EmpleadosFaltas.frx":38DA
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   2280
         Width           =   2055
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   5
      Left            =   6360
      MouseIcon       =   "EmpleadosFaltas.frx":3D1C
      Picture         =   "EmpleadosFaltas.frx":415E
      Style           =   1  'Graphical
      TabIndex        =   8
      Top             =   4320
      Width           =   1000
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   4
      Left            =   5280
      MouseIcon       =   "EmpleadosFaltas.frx":61D0
      Picture         =   "EmpleadosFaltas.frx":6612
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   4320
      Width           =   1000
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   3
      Left            =   4200
      MouseIcon       =   "EmpleadosFaltas.frx":6B44
      Picture         =   "EmpleadosFaltas.frx":6F86
      Style           =   1  'Graphical
      TabIndex        =   6
      Top             =   4320
      Width           =   1000
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   2
      Left            =   3120
      MouseIcon       =   "EmpleadosFaltas.frx":74B8
      Picture         =   "EmpleadosFaltas.frx":78FA
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   4320
      Width           =   1000
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   1
      Left            =   2040
      MouseIcon       =   "EmpleadosFaltas.frx":7E2C
      Picture         =   "EmpleadosFaltas.frx":826E
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   4320
      Width           =   1000
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   0
      Left            =   960
      MouseIcon       =   "EmpleadosFaltas.frx":87A0
      Picture         =   "EmpleadosFaltas.frx":8BE2
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   4320
      Width           =   1000
   End
End
Attribute VB_Name = "EmpleadosFaltas"
    ...
    On Error Resume Next
            ...
            ElseIf Index = 2 Then
                    If BEditar = False Then 'ESTA AGREGANDO UN REGISTRO
                         Conexion.Execute "Insert Into EmpleadosFaltas Values('" & Txttexto.Item(0).Text & "', '" & Txttexto.Item(1).Text & "', '" & Txttexto.Item(2).Text & "')"
                    Else 'ESTA EDITANDO UN REGISTRO
                         Conexion.Execute "UPDATE EmpleadosFaltas SET Descripcion = '" & Txttexto.Item(1).Text & "', Usuario = '" & Txttexto.Item(2).Text & "' Where Codigo = '" & Txttexto.Item(0).Text & "'"
                    End If
                    
                    'SI SE DUPLICA LA LLAVE
                     If GOrigenDeDatos = "AmaproAccess" Then
                        If Err = -2147467259 Then
                            MsgBox "Codigo De Falta Ya Existe", vbOKOnly + vbInformation, "Informacion"
                            Txttexto.Item(0).SetFocus
                            Exit Sub
...
Private Sub CmdBuscar_Click(Index As Integer)
        ...
        If Index = 0 Then
            If OptCodigo.Value = True Then
                If GOrigenDeDatos = "AmaproAccess" Then
                    Call Abrir_Recordset(RDocumentos, "Select * from EmpleadosFaltas where Codigo Like '%" & TxtBuscar.Text & "%'")
                Else 'ORACLE
                    Call Abrir_Recordset(RDocumentos, "Select * from EmpleadosFaltas where UPPER(Codigo) Like '%" & UCase(TxtBuscar.Text) & "%'")
                End If
            ElseIf OptDescripcion.Value = True Then
                If GOrigenDeDatos = "AmaproAccess" Then
                    Call Abrir_Recordset(RDocumentos, "Select * from EmpleadosFaltas where Descripcion Like '%" & TxtBuscar.Text & "%'")
                Else 'ORACLE
                    Call Abrir_Recordset(RDocumentos, "Select * from EmpleadosFaltas where UPPER(Descripcion) Like '%" & UCase(TxtBuscar.Text) & "%'")
                End If
            End If
        'SELECCIONAR TODOS LOS DATOS
        ElseIf Index = 1 Then
                Call Abrir_Recordset(RDocumentos, "Select * From EmpleadosFaltas")
        End If
