...
Begin VB.Form CierrePedidosClientes 
   BackColor       =   &H0000C000&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Cierre De Pedidos De Clientes"
   ClientHeight    =   8550
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11760
   Icon            =   "CierrePedidosClientes.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Frame FrameBuscar 
      ...
      Begin VB.CommandButton Command1 
         Height          =   615
         Left            =   10920
         Picture         =   "CierrePedidosClientes.frx":08CA
         Style           =   1  'Graphical
         TabIndex        =   31
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   4
      Left            =   11400
      MouseIcon       =   "CierrePedidosClientes.frx":293C
      Picture         =   "CierrePedidosClientes.frx":2D7E
      Style           =   1  'Graphical
      TabIndex        =   51
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   3
      Left            =   11040
      MouseIcon       =   "CierrePedidosClientes.frx":32B0
      Picture         =   "CierrePedidosClientes.frx":36F2
      Style           =   1  'Graphical
      TabIndex        =   50
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   2
      Left            =   360
      MouseIcon       =   "CierrePedidosClientes.frx":3C24
      Picture         =   "CierrePedidosClientes.frx":4066
      Style           =   1  'Graphical
      TabIndex        =   49
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   1
      Left            =   0
      MouseIcon       =   "CierrePedidosClientes.frx":4598
      Picture         =   "CierrePedidosClientes.frx":49DA
      Style           =   1  'Graphical
      TabIndex        =   48
   ...
   Begin TabDlg.SSTab TabInformacion 
      ...
      TabPicture(0)   =   "CierrePedidosClientes.frx":4F0C
      ...
      TabPicture(1)   =   "CierrePedidosClientes.frx":5366
      ...
      Begin VB.Frame FrameDetalle 
         ...
         Begin VB.CommandButton CmdAgregar2 
            ...
            Height          =   495
            Left            =   120
            Picture         =   "CierrePedidosClientes.frx":B600
            Style           =   1  'Graphical
            TabIndex        =   21
            Top             =   4440
            Visible         =   0   'False
         ...
         Begin VB.CommandButton CmdGrabar2 
            ...
            Height          =   495
            Left            =   2400
            Picture         =   "CierrePedidosClientes.frx":BB32
            Style           =   1  'Graphical
            TabIndex        =   22
            Top             =   4440
            Visible         =   0   'False
         ...
         Begin VB.CommandButton CmdTerminar 
            ...
            Height          =   495
            Left            =   9240
            Picture         =   "CierrePedidosClientes.frx":C064
            TabIndex        =   25
            Top             =   4440
            Visible         =   0   'False
            Width           =   2200
         ...
         Begin VB.CommandButton CmdCancelar2 
            ...
            Height          =   495
            Left            =   4680
            Picture         =   "CierrePedidosClientes.frx":C596
            Style           =   1  'Graphical
            TabIndex        =   23
            Top             =   4440
            Visible         =   0   'False
         ...
         Begin VB.CommandButton CmdBorrar2 
            ...
            Height          =   495
            Left            =   6960
            Picture         =   "CierrePedidosClientes.frx":CAC8
            Style           =   1  'Graphical
            TabIndex        =   24
            Top             =   4440
            Visible         =   0   'False
   ...
   Begin VB.Frame FrameEncabezado 
      ...
      Begin VB.CommandButton CmdImprimir 
         ...
         Height          =   480
         Left            =   8760
         Picture         =   "CierrePedidosClientes.frx":CFFA
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   1680
         Width           =   1400
      ...
      Begin VB.CommandButton CmdEditar 
         ...
         Height          =   480
         Left            =   1560
         Picture         =   "CierrePedidosClientes.frx":D52C
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   1680
         Width           =   1400
      ...
      Begin VB.CommandButton CmdBuscar 
         ...
         Height          =   480
         Left            =   7320
         Picture         =   "CierrePedidosClientes.frx":DA5E
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   1680
         Width           =   1400
      ...
      Begin VB.CommandButton CmdSalida 
         ...
         Height          =   480
         Left            =   10200
         Picture         =   "CierrePedidosClientes.frx":DF90
         Style           =   1  'Graphical
         TabIndex        =   13
         ToolTipText     =   "Salida"
         Top             =   1680
      ...
      Begin VB.CommandButton CmdBorrar 
         ...
         Height          =   480
         Left            =   5880
         Picture         =   "CierrePedidosClientes.frx":10002
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   1680
         Width           =   1400
      ...
      Begin VB.CommandButton CmdCancelar 
         ...
         Height          =   480
         Left            =   4440
         Picture         =   "CierrePedidosClientes.frx":10534
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   1680
         Width           =   1400
      ...
      Begin VB.CommandButton CmdGrabar 
         ...
         Height          =   480
         Left            =   3000
         Picture         =   "CierrePedidosClientes.frx":10A66
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   1680
         Width           =   1400
      ...
      Begin VB.CommandButton CmdAgregar 
         ...
         Height          =   480
         Left            =   120
         Picture         =   "CierrePedidosClientes.frx":10F98
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   1680
         Width           =   1400
      ...
      Begin VB.Frame FrameEncabezado2 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   10920
            Picture         =   "CierrePedidosClientes.frx":114CA
            Top             =   120
            Width           =   480
         End
   ...
   End
End
Attribute VB_Name = "CierrePedidosClientes"
...
On Error Resume Next
            ...
            If VMensaje = vbOK Then
                ...
                Set RBuscaDetalle = New ADODB.Recordset
                    Call Abrir_Recordset(RBuscaDetalle, "Select * from DetalleCierrePedidosCliente where Documento = " & VTransaccion & " Order by Codigo")
                    If RBuscaDetalle.RecordCount > 0 Then
                        ...
                        Do Until RBuscaDetalle.EOF
                                    ...
                                    If GOrigenDeDatos = "AmaproAccess" Then
                                        Conexion.Execute "Update DetallePedidosClientes Set CantidadEntregada = CantidadEntregada - " & RBuscaDetalle!Cantidad & ", SaldoPorEntregar = SaldoPorEntregar + " & RBuscaDetalle!Cantidad & " Where Documento = '" & RBuscaDetalle!Pedido & "' And Codigo = '" & RBuscaDetalle!Codigo & "'"
                                    Else 'ORACLE
                                        Conexion.Execute "Update DetallePedidosClientes Set CantidadEntregada = CantidadEntregada - " & RBuscaDetalle!Cantidad & ", SaldoPorEntregar = SaldoPorEntregar + " & RBuscaDetalle!Cantidad & " Where UPPER(Documento) = '" & UCase(RBuscaDetalle!Pedido) & "' And UPPER(Codigo) = '" & UCase(RBuscaDetalle!Codigo) & "'"
                                    End If
                                ...
                                Set RBuscaPedido = New ADODB.Recordset
                                    If GOrigenDeDatos = "AmaproAccess" Then
                                        Call Abrir_Recordset(RBuscaPedido, "Select SaldoPorEntregar From DetallepedidosClientes Where Documento = '" & RBuscaDetalle!Pedido & "' And Codigo = '" & RBuscaDetalle!Codigo & "'")
                                    Else 'ORACLE
                                        Call Abrir_Recordset(RBuscaPedido, "Select SaldoPorEntregar From DetallepedidosClientes Where UPPER(Documento) = '" & UCase(RBuscaDetalle!Pedido) & "' And UPPER(Codigo) = '" & UCase(RBuscaDetalle!Codigo) & "'")
                                    End If
                                    ...
                                    If RBuscaPedido.RecordCount > 0 Then
                                            ...
                                            If RBuscaPedido!SaldoPorEntregar > 0 Then
                                                    If GOrigenDeDatos = "AmaproAccess" Then
                                                        Conexion.Execute "Update DetallePedidosClientes Set FechaEntregatotal = '', DiasDeAtraso = 0 Where Documento = '" & RBuscaDetalle!Pedido & "' And Codigo = '" & RBuscaDetalle!Codigo & "'"
                                                    Else 'ORACLE
                                                        Conexion.Execute "Update DetallePedidosClientes Set FechaEntregatotal = '', DiasDeAtraso = 0 Where UPPER(Documento) = '" & UCase(RBuscaDetalle!Pedido) & "' And UPPER(Codigo) = '" & UCase(RBuscaDetalle!Codigo) & "'"
                                                    End If
                    ...
                    'VUELVE A LLENAR EL RECORDSET DE SU ESTADO ORIGINAL
                        ...
                        Llena_CamposEncabezado
                            ...
                            Set RDetalle = New ADODB.Recordset
                                    If GOrigenDeDatos = "AmaproAccess" Then
                                        Call Abrir_Recordset(RDetalle, "Select D.Documento, D.Codigo, F.Descrip, D.Pedido, D.Cantidad From EncabezadoCierrePedidosCliente E, DetalleCierrePedidosCliente D, FichaTecnica F Where E.Documento = " & TxtDoc.Text & " And E.Documento = D.Documento And D.Codigo = F.Esp_Tec")
                                    Else 'ORACLE
                                        Call Abrir_Recordset(RDetalle, "Select D.Documento, D.Codigo, F.Descrip, D.Pedido, D.Cantidad From EncabezadoCierrePedidosCliente E, DetalleCierrePedidosCliente D, FichaTecnica F Where E.Documento = " & TxtDoc.Text & " And E.Documento = D.Documento And UPPER(D.Codigo) = UPPER(F.Esp_Tec)")
                                    End If
                                        Llena_CamposDetalle
...
On Error Resume Next
                ...
                If VMensaje = vbYes Then
                        ...
                        Conexion.BeginTrans
                                    ...
                                    If GOrigenDeDatos = "AmaproAccess" Then
                                        Conexion.Execute "Update DetallePedidosClientes Set CantidadEntregada = CantidadEntregada - " & VCantidadEntrada & ", SaldoPorEntregar = SaldoPorEntregar + " & VCantidadEntrada & " Where Documento = '" & VNumeroPedido & "' And Codigo = '" & VCodigo & "'"
                                    Else 'ORACLE
                                        Conexion.Execute "Update DetallePedidosClientes Set CantidadEntregada = CantidadEntregada - " & VCantidadEntrada & ", SaldoPorEntregar = SaldoPorEntregar + " & VCantidadEntrada & " Where UPPER(Documento) = '" & UCase(VNumeroPedido) & "' And UPPER(Codigo) = '" & UCase(VCodigo) & "'"
                                    End If
                                ...
                                Set RBuscaPedido = New ADODB.Recordset
                                    If GOrigenDeDatos = "AmaproAccess" Then
                                        Call Abrir_Recordset(RBuscaPedido, "Select SaldoPorEntregar From DetallepedidosClientes Where Documento = '" & VNumeroPedido & "' And Codigo = '" & VCodigo & "'")
                                    Else 'ORACLE
                                        Call Abrir_Recordset(RBuscaPedido, "Select SaldoPorEntregar From DetallepedidosClientes Where UPPER(Documento) = '" & UCase(VNumeroPedido) & "' And UPPER(Codigo) = '" & UCase(VCodigo) & "'")
                                    End If
                                    ...
                                    If RBuscaPedido.RecordCount > 0 Then
                                            ...
                                            If RBuscaPedido!SaldoPorEntregar > 0 Then
                                                    If GOrigenDeDatos = "AmaproAccess" Then
                                                        Conexion.Execute "Update DetallePedidosClientes Set FechaEntregatotal = '', DiasDeAtraso = 0 Where Documento = '" & VNumeroPedido & "' And Codigo = '" & VCodigo & "'"
                                                    Else 'ORACLE
                                                        Conexion.Execute "Update DetallePedidosClientes Set FechaEntregatotal = '', DiasDeAtraso = 0 Where UPPER(Documento) = '" & UCase(VNumeroPedido) & "' And UPPER(Codigo) = '" & UCase(VCodigo) & "'"
                                                    End If
                        ...
                        'BORRA EL REGISTRO
                        Conexion.Execute "Delete From DetalleCierrePedidosCliente Where Documento = " & VTransaccion & " And Codigo = '" & VCodigo & "' And Pedido = '" & VNumeroPedido & "'"
...
On Error Resume Next
    VMensaje = InputBox("Transaccion a Buscar")
    If VMensaje <> "" Then
                'REncabezado.MoveFirst
                'REncabezado.Find " Documento = " & VMensaje
                Set REncabezado = New ADODB.Recordset
                    If GOrigenDeDatos = "AmaproAccess" Then
                        Call Abrir_Recordset(REncabezado, "Select * From EncabezadoCierrePedidosCliente Where NumeroDocumento Like '" & VMensaje & "%' Order By Documento")
                    Else
                        Call Abrir_Recordset(REncabezado, "Select * From EncabezadoCierrePedidosCliente Where UPPER(NumeroDocumento) Like '" & UCase(VMensaje) & "%' Order By Documento")
                    End If
                        Llena_CamposEncabezado
...
On Error Resume Next
                ...
                Set RBuscaPedido2 = New ADODB.Recordset
                    If GOrigenDeDatos = "AmaproAccess" Then
                        Call Abrir_Recordset(RBuscaPedido2, "Select * From DetallePedidosClientes Where Documento = '" & TxtPed.Text & "' And Codigo = '" & TxtCod.Text & "'")
                    Else 'ORACLE
                        Call Abrir_Recordset(RBuscaPedido2, "Select * From DetallePedidosClientes Where UPPER(Documento) = '" & UCase(TxtPed.Text) & "' And UPPER(Codigo) = '" & UCase(TxtCod.Text) & "'")
                    End If
                        
                        If RBuscaPedido2.RecordCount > 0 Then
                        Else
                                 MsgBox "No. Pedido y Codigo De Producto, No Existe En Pedidos De Clientes", vbOKOnly + vbInformation, "Informacion"
                                 Exit Sub
                        End If
                ...
                VCodigo = TxtCod.Text
                    ...
                    Conexion.BeginTrans
                                    ...
                                    Conexion.Execute "Insert Into DetalleCierrePedidosCliente " & VTexto
                                ...
                                Set RBuscaPedido = New ADODB.Recordset
                                    If GOrigenDeDatos = "AmaproAccess" Then
                                        Call Abrir_Recordset(RBuscaPedido, "Select SaldoPorEntregar, FechaParaEntregar From DetallepedidosClientes Where Documento = '" & VNumeroPedido & "' And Codigo = '" & VCodigo & "'")
                                    Else 'ORACLE
                                        Call Abrir_Recordset(RBuscaPedido, "Select SaldoPorEntregar, FechaParaEntregar From DetallepedidosClientes Where UPPER(Documento) = '" & UCase(VNumeroPedido) & "' And UPPER(Codigo) = '" & UCase(VCodigo) & "'")
                                    End If
                                    ...
                                    If RBuscaPedido.RecordCount > 0 Then
                                            ...
                                            If RBuscaPedido!SaldoPorEntregar <= 0 Then
                                                    ...
                                                    If GOrigenDeDatos = "AmaproAccess" Then
                                                        Conexion.Execute "Update DetallePedidosClientes Set FechaEntregatotal = '" & VFechaEntrada & "', DiasDeAtraso = " & VDiasDeAtraso & " Where Documento = '" & VNumeroPedido & "' And Codigo = '" & VCodigo & "'"
                                                    Else 'ORACLE
                                                        Conexion.Execute "Update DetallePedidosClientes Set FechaEntregatotal = '" & VFechaEntrada & "', DiasDeAtraso = " & VDiasDeAtraso & " Where UPPER(Documento) = '" & UCase(VNumeroPedido) & "' And UPPER(Codigo) = '" & UCase(VCodigo) & "'"
                                                    End If
...
Private Sub CmdAgregar_Click()
    ...
    Set RBuscaSigDoc = New ADODB.Recordset
        Call Abrir_Recordset(RBuscaSigDoc, "Select Max(Documento) from EncabezadoCierrePedidosCliente")
...
On Error Resume Next
    ...
    If BEditarEncabezado = False Then
            ...
            Set RBuscaDocumento = New ADODB.Recordset
                If GOrigenDeDatos = "AmaproAccess" Then
                    Call Abrir_Recordset(RBuscaDocumento, "Select * From EncabezadoCierrePedidosCliente Where TipoDeDocumento = '" & TxtTipDoc.Text & "' And NumeroDocumento = '" & TxtNumDoc.Text & "'")
                Else
                    Call Abrir_Recordset(RBuscaDocumento, "Select * From EncabezadoCierrePedidosCliente Where UPPER(TipoDeDocumento) = '" & UCase(TxtTipDoc.Text) & "' And UPPER(NumeroDocumento) = '" & UCase(TxtNumDoc.Text) & "'")
                End If
    ...
    VFechaPedido = MskFec.Text
                    ...
                    If BEditarEncabezado = False Then
                            ...
                            Conexion.Execute "Insert Into EncabezadoCierrePedidosCliente " & VTexto
                    'EDITAR
                    Else
                            ...
                            Conexion.Execute "UPDATE EncabezadoCierrePedidosCliente SET " & VTexto
                    End If
                    ...
                    End If
                        ...
                        Set REncabezado = New ADODB.Recordset
                        Call Abrir_Recordset(REncabezado, "Select * From EncabezadoCierrePedidosCliente Where Documento = " & VTransaccion & " Order By Documento")
                        
                        Llena_CamposEncabezado
   
                        Set RDetalle = New ADODB.Recordset
                                 If GOrigenDeDatos = "AmaproAccess" Then
                                     Call Abrir_Recordset(RDetalle, "Select D.Documento, D.Codigo, F.Descrip, D.Pedido, D.Cantidad From EncabezadoCierrePedidosCliente E, DetalleCierrePedidosCliente D, FichaTecnica F Where E.Documento = " & VTransaccion & " And E.Documento = D.Documento And D.Codigo = F.Esp_Tec")
                                 Else 'ORACLE
                                     Call Abrir_Recordset(RDetalle, "Select D.Documento, D.Codigo, F.Descrip, D.Pedido, D.Cantidad From EncabezadoCierrePedidosCliente E, DetalleCierrePedidosCliente D, FichaTecnica F Where E.Documento = " & VTransaccion & " And E.Documento = D.Documento And UPPER(D.Codigo) = UPPER(F.Esp_Tec)")
                                 End If
                                     Llena_CamposDetalle
                                     Set DbGridDetalle.DataSource = RDetalle
...
MousePointer = 11
                ...
                End If
                GCriteriaReporte = "{EncabezadoCierrePedidosCliente.Documento} = " & TxtDoc.Text
                FrmReporte.Show
...
End If
    ...
    Set REncabezado = New ADODB.Recordset
            Call Abrir_Recordset(REncabezado, "Select * From EncabezadoCierrePedidosCliente Order By Documento")
            REncabezado.MoveLast
                Llena_CamposEncabezado
    ...
    If TabInformacion.Tab = 1 Then
       ...
       'BUSCA EL ENCABEZADO DE PEDIDO
        Set RBuscaSaldoEncabezado = New ADODB.Recordset
            If GOrigenDeDatos = "AmaproAccess" Then
                Call Abrir_Recordset(RBuscaSaldoEncabezado, "Select EP.Fecha, P.Descripcion, EP.Observaciones, EP.Documento From EncabezadoPedidosClientes EP, Clientes P Where EP.Documento = '" & TxtPed.Text & "' And EP.Cliente = P.CodigoCliente")
            Else 'ORACLE
                Call Abrir_Recordset(RBuscaSaldoEncabezado, "Select EP.Fecha, P.Descripcion, EP.Observaciones, EP.Documento From EncabezadoPedidosClientes EP, Clientes P Where UPPER(EP.Documento) = '" & UCase(TxtPed.Text) & "' And UPPER(EP.Cliente) = UPPER(P.CodigoCliente)")
            End If
                   If RBuscaSaldoEncabezado.RecordCount > 0 Then
                       ...
                       Set RBuscaSaldoDetalle = New ADODB.Recordset
                            If GOrigenDeDatos = "AmaproAccess" Then
                                Call Abrir_Recordset(RBuscaSaldoDetalle, "Select * From DetallepedidosClientes Where Documento = '" & TxtPed.Text & "' And Codigo = '" & TxtCod.Text & "'")
                            Else 'ORACLE
                                Call Abrir_Recordset(RBuscaSaldoDetalle, "Select * From DetallepedidosClientes Where UPPER(Documento) = '" & UCase(TxtPed.Text) & "' And UPPER(Codigo) = '" & UCase(TxtCod.Text) & "'")
                            End If
                   ...
                   End If
                    ...
                    Set RBuscaCierrePedidos = New ADODB.Recordset
                        If GOrigenDeDatos = "AmaproAccess" Then
                            Call Abrir_Recordset(RBuscaCierrePedidos, "Select EC.Fecha, D.Descripcion, EC.NumeroDocumento, DC.Cantidad From DetalleCierrePedidosCliente DC, EncabezadoCierrePedidosCliente EC, Documentos as D Where DC.Pedido = '" & TxtPed.Text & "' And DC.Codigo = '" & TxtCod.Text & "' And DC.Documento = EC.Documento And EC.TipoDeDocumento = D.CodigoDocumento")
                        Else 'ORACLE
                            Call Abrir_Recordset(RBuscaCierrePedidos, "Select EC.Fecha, D.Descripcion, EC.NumeroDocumento, DC.Cantidad From DetalleCierrePedidosCliente DC, EncabezadoCierrePedidosCliente EC, Documentos D Where UPPER(DC.Pedido) = '" & UCase(TxtPed.Text) & "' And UPPER(DC.Codigo) = '" & UCase(TxtCod.Text) & "' And DC.Documento = EC.Documento And UPPER(EC.TipoDeDocumento) = UPPER(D.CodigoDocumento)")
                        End If
...
Private Sub TxtPed_DblClick()
        Set RBusqueda = New ADODB.Recordset
            If GOrigenDeDatos = "AmaproAccess" Then
                Call Abrir_Recordset(RBusqueda, "Select P.Fecha, P.Documento, DP.CantidadPedido, DP.CantidadEntregada, DP.SaldoPorEntregar, DP.FechaParaEntregar, Pr.Descripcion From EncabezadoPedidosClientes P, Clientes Pr, DetallepedidosClientes DP Where DP.Codigo = '" & TxtCod.Text & "' And DP.SaldoPorEntregar > 0 And P.Documento = DP.Documento And P.Cliente = Pr.CodigoCliente Order By Fecha")
            Else 'ORACLE
                Call Abrir_Recordset(RBusqueda, "Select P.Fecha, P.Documento, DP.CantidadPedido, DP.CantidadEntregada, DP.SaldoPorEntregar, DP.FechaParaEntregar, Pr.Descripcion From EncabezadoPedidosClientes P, Clientes Pr, DetallepedidosClientes DP Where UPPER(DP.Codigo) = '" & UCase(TxtCod.Text) & "' And DP.SaldoPorEntregar > 0 And P.Documento = DP.Documento And UPPER(P.Cliente) = UPPER(Pr.CodigoCliente) Order By Fecha")
            End If
        ...
        Set DbGridBuscar.DataSource = RBusqueda
                        ...
                        DbGridBuscar.Columns(6).Caption = "Cliente"
