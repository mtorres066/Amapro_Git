...
Begin VB.Form EmpleadosHabilidades 
   BackColor       =   &H0080C0FF&
   ...
   ClientTop       =   330
   ClientWidth     =   8415
   Icon            =   "EmpleadosHabilidades.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5175
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   1
      Left            =   120
      MouseIcon       =   "EmpleadosHabilidades.frx":0442
      Picture         =   "EmpleadosHabilidades.frx":0884
      Style           =   1  'Graphical
      TabIndex        =   26
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   2
      Left            =   480
      MouseIcon       =   "EmpleadosHabilidades.frx":0DB6
      Picture         =   "EmpleadosHabilidades.frx":11F8
      Style           =   1  'Graphical
      TabIndex        =   25
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   3
      Left            =   7440
      MouseIcon       =   "EmpleadosHabilidades.frx":172A
      Picture         =   "EmpleadosHabilidades.frx":1B6C
      Style           =   1  'Graphical
      TabIndex        =   24
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   4
      Left            =   7800
      MouseIcon       =   "EmpleadosHabilidades.frx":209E
      Picture         =   "EmpleadosHabilidades.frx":24E0
      Style           =   1  'Graphical
      TabIndex        =   23
   ...
   Begin TabDlg.SSTab TabPuestos 
      ...
      TabPicture(0)   =   "EmpleadosHabilidades.frx":2A12
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "FramePuestos"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Vista General"
      TabPicture(1)   =   "EmpleadosHabilidades.frx":2D2C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "DataGrid1"
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "Busqueda De Datos"
      TabPicture(2)   =   "EmpleadosHabilidades.frx":317E
      ...
      Begin VB.CommandButton CmdBuscar 
         ...
         Index           =   1
         Left            =   -68760
         Picture         =   "EmpleadosHabilidades.frx":35D0
         Style           =   1  'Graphical
         TabIndex        =   22
         Top             =   3240
         Width           =   2055
      ...
      Begin VB.CommandButton CmdBuscar 
         ...
         Index           =   0
         Left            =   -68760
         Picture         =   "EmpleadosHabilidades.frx":38DA
         Style           =   1  'Graphical
         TabIndex        =   20
         Top             =   2280
         Width           =   2055
      ...
      Begin VB.Frame FramePuestos 
         ...
         Begin VB.ComboBox CboTipo 
            ...
            DataSource      =   "Data"
            Height          =   315
            ItemData        =   "EmpleadosHabilidades.frx":3D1C
            Left            =   1200
            List            =   "EmpleadosHabilidades.frx":3D26
            TabIndex        =   2
            Text            =   "ACTITUDINAL"
            Top             =   1080
            Width           =   1935
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   5
      Left            =   6360
      MouseIcon       =   "EmpleadosHabilidades.frx":3D44
      Picture         =   "EmpleadosHabilidades.frx":4186
      Style           =   1  'Graphical
      TabIndex        =   9
      Top             =   4320
      Width           =   1000
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   4
      Left            =   5280
      MouseIcon       =   "EmpleadosHabilidades.frx":61F8
      Picture         =   "EmpleadosHabilidades.frx":663A
      Style           =   1  'Graphical
      TabIndex        =   8
      Top             =   4320
      Width           =   1000
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   3
      Left            =   4200
      MouseIcon       =   "EmpleadosHabilidades.frx":6B6C
      Picture         =   "EmpleadosHabilidades.frx":6FAE
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   4320
      Width           =   1000
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   2
      Left            =   3120
      MouseIcon       =   "EmpleadosHabilidades.frx":74E0
      Picture         =   "EmpleadosHabilidades.frx":7922
      Style           =   1  'Graphical
      TabIndex        =   6
      Top             =   4320
      Width           =   1000
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   1
      Left            =   2040
      MouseIcon       =   "EmpleadosHabilidades.frx":7E54
      Picture         =   "EmpleadosHabilidades.frx":8296
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   4320
      Width           =   1000
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   0
      Left            =   960
      MouseIcon       =   "EmpleadosHabilidades.frx":87C8
      Picture         =   "EmpleadosHabilidades.frx":8C0A
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   4320
      Width           =   1000
   End
End
Attribute VB_Name = "EmpleadosHabilidades"
    ...
    On Error Resume Next
            ...
            ElseIf Index = 2 Then
                    If BEditar = False Then 'ESTA AGREGANDO UN REGISTRO
                         Conexion.Execute "Insert Into EmpleadosHabilidades Values('" & Txttexto.Item(0).Text & "', '" & Txttexto.Item(1).Text & "', '" & CboTipo.Text & "', '" & Txttexto.Item(2).Text & "')"
                    Else 'ESTA EDITANDO UN REGISTRO
                         Conexion.Execute "UPDATE EmpleadosHabilidades SET Descripcion = '" & Txttexto.Item(1).Text & "', Tipo = '" & CboTipo.Text & "', Usuario = '" & Txttexto.Item(2).Text & "' Where Codigo = '" & Txttexto.Item(0).Text & "'"
                    End If
                    
                    'SI SE DUPLICA LA LLAVE
                     If GOrigenDeDatos = "AmaproAccess" Then
                        If Err = -2147467259 Then
                            MsgBox "Codigo De Habilidad Ya Existe", vbOKOnly + vbInformation, "Informacion"
                            Txttexto.Item(0).SetFocus
                            Exit Sub
...
Private Sub CmdBuscar_Click(Index As Integer)
        ...
        If Index = 0 Then
            If OptCodigo.Value = True Then
                If GOrigenDeDatos = "AmaproAccess" Then
                    Call Abrir_Recordset(RDocumentos, "Select * from EmpleadosHabilidades where Codigo Like '%" & TxtBuscar.Text & "%'")
                Else 'ORACLE
                    Call Abrir_Recordset(RDocumentos, "Select * from EmpleadosHabilidades where UPPER(Codigo) Like '%" & UCase(TxtBuscar.Text) & "%'")
                End If
            ElseIf OptDescripcion.Value = True Then
                If GOrigenDeDatos = "AmaproAccess" Then
                    Call Abrir_Recordset(RDocumentos, "Select * from EmpleadosHabilidades where Descripcion Like '%" & TxtBuscar.Text & "%'")
                Else 'ORACLE
                    Call Abrir_Recordset(RDocumentos, "Select * from EmpleadosHabilidades where UPPER(Descripcion) Like '%" & UCase(TxtBuscar.Text) & "%'")
                End If
            End If
        'SELECCIONAR TODOS LOS DATOS
        ElseIf Index = 1 Then
                Call Abrir_Recordset(RDocumentos, "Select * From EmpleadosHabilidades")
        End If
