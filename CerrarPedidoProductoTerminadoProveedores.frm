...
Begin VB.Form CerrarPedidoProductoTerminadoProveedores 
   BackColor       =   &H00FF8080&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Cerrar Pedidos De Producto Terminado De Proveedores"
   ClientHeight    =   6345
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9315
   Icon            =   "CerrarPedidoProductoTerminadoProveedores.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6345
   ...
   Begin VB.Frame FrameBusqueda 
      ...
      Begin VB.CommandButton CmdSale 
         Height          =   615
         Left            =   8160
         Picture         =   "CerrarPedidoProductoTerminadoProveedores.frx":08CA
         Style           =   1  'Graphical
         TabIndex        =   30
      ...
      Begin MSDBGrid.DBGrid DBGridBusqueda 
         Bindings        =   "CerrarPedidoProductoTerminadoProveedores.frx":293C
         Height          =   5775
         Left            =   120
         OleObjectBlob   =   "CerrarPedidoProductoTerminadoProveedores.frx":2957
         TabIndex        =   29
   ...
   Begin VB.Data DataCerrarPedidos 
      Caption         =   "Cerrar Pedido De Producto Terminado De Proveedores"
      Connect         =   "Access"
      ...
      ReadOnly        =   0   'False
      RecordsetType   =   1  'Dynaset
      RecordSource    =   "CerrarPedidoProductoTerminadoProveedores"
      Top             =   5040
      Width           =   9135
   End
   Begin TabDlg.SSTab TabDepartamentos 
      ...
      TabPicture(0)   =   "CerrarPedidoProductoTerminadoProveedores.frx":3331
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "FrameCerrarPedidos"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Vista General"
      TabPicture(1)   =   "CerrarPedidoProductoTerminadoProveedores.frx":364B
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "DGridCerrarPedidos"
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "Busqueda"
      TabPicture(2)   =   "CerrarPedidoProductoTerminadoProveedores.frx":3A9D
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "FrameBusquedadeDatos"
      Tab(2).ControlCount=   1
      Begin MSDBGrid.DBGrid DGridCerrarPedidos 
         Bindings        =   "CerrarPedidoProductoTerminadoProveedores.frx":3EEF
         Height          =   3975
         Left            =   -74880
         OleObjectBlob   =   "CerrarPedidoProductoTerminadoProveedores.frx":3F0F
         TabIndex        =   13
      ...
      Begin VB.Frame FrameBusquedadeDatos 
         ...
         Begin VB.OptionButton OptBusqueda 
            ...
            Index           =   2
            Left            =   3000
            Picture         =   "CerrarPedidoProductoTerminadoProveedores.frx":5181
            Style           =   1  'Graphical
            TabIndex        =   37
            Top             =   360
            Width           =   1335
         ...
         Begin VB.OptionButton OptBusqueda 
            ...
            Index           =   1
            Left            =   1560
            Picture         =   "CerrarPedidoProductoTerminadoProveedores.frx":548B
            Style           =   1  'Graphical
            TabIndex        =   16
            Top             =   360
            Width           =   1335
         ...
         Begin VB.OptionButton OptBusqueda 
            ...
            Index           =   0
            Left            =   120
            Picture         =   "CerrarPedidoProductoTerminadoProveedores.frx":8305
            Style           =   1  'Graphical
            TabIndex        =   15
            Top             =   360
            Value           =   -1  'True
         ...
         Begin MSForms.CommandButton CmdBotones 
            ...
            PicturePosition =   196613
            Size            =   "4471;1085"
            Picture         =   "CerrarPedidoProductoTerminadoProveedores.frx":D907
            FontEffects     =   1073741825
            FontHeight      =   165
            FontCharSet     =   0
            FontPitchAndFamily=   2
      ...
      Begin VB.Frame FrameCerrarPedidos 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   3840
            Picture         =   "CerrarPedidoProductoTerminadoProveedores.frx":DD59
            Top             =   480
            Width           =   480
         End
   ...
   Begin MSForms.CommandButton CmdBotones 
      ...
      PicturePosition =   196613
      Size            =   "3175;1085"
      Picture         =   "CerrarPedidoProductoTerminadoProveedores.frx":E623
      Accelerator     =   65
      FontEffects     =   1073741825
      FontHeight      =   165
      FontCharSet     =   0
   ...
   Begin MSForms.CommandButton CmdBotones 
      ...
      PicturePosition =   196613
      Size            =   "3175;1085"
      Picture         =   "CerrarPedidoProductoTerminadoProveedores.frx":EB65
      Accelerator     =   71
   ...
   Begin MSForms.CommandButton CmdBotones 
      ...
      PicturePosition =   196613
      Size            =   "3175;1085"
      Picture         =   "CerrarPedidoProductoTerminadoProveedores.frx":F0A7
      Accelerator     =   67
      FontEffects     =   1073750017
      FontHeight      =   165
      FontCharSet     =   0
   ...
   Begin MSForms.CommandButton CmdBotones 
      ...
      PicturePosition =   196613
      Size            =   "3175;1085"
      Picture         =   "CerrarPedidoProductoTerminadoProveedores.frx":F5E9
      Accelerator     =   66
      FontEffects     =   1073741825
      FontHeight      =   165
      FontCharSet     =   0
   ...
   Begin MSForms.CommandButton CmdBotones 
      ...
      PicturePosition =   196613
      Size            =   "3387;1085"
      Picture         =   "CerrarPedidoProductoTerminadoProveedores.frx":FB2B
      Accelerator     =   83
      FontEffects     =   1073741825
      FontHeight      =   165
      FontCharSet     =   0
   ...
   End
End
Attribute VB_Name = "CerrarPedidoProductoTerminadoProveedores"
...
On Error Resume Next
    With DataCerrarPedidos.Recordset
        ...
        ElseIf Index = 2 Then
                ...
                Set RBuscaPedido2 = Db.OpenRecordset("Select * From PedidosProductoTerminadoProveedores Where Documento = '" & TxtTexto.Item(2).Text & "'")
                If RBuscaPedido2.RecordCount > 0 Then
                Else
                         MsgBox "Pedido No Existe", vbOKOnly + vbInformation, "Informacion"
                End If
                
                'REVISA SI EXISTE EL PEDIDO Y CON LA FICHA TECNICA
                Set RBuscaPedido3 = Db.OpenRecordset("Select * From PedidosProductoTerminadoProveedores Where Documento = '" & TxtTexto.Item(2).Text & "' And Codigo = '" & TxtTexto.Item(1).Text & "'")
                    If RBuscaPedido3.RecordCount > 0 Then
                    Else
                             MsgBox "Este Pedido No Corresponde A Esta Ficha Tecnica", vbOKOnly + vbInformation, "Informacion"
                    End If
                    
                'BUSCA EL SALDO DEL PEDIDO
                Set RBuscaSaldo = Db.OpenRecordset("Select SaldoPorEntregar From PedidosProductoTerminadoProveedores Where Documento = '" & TxtTexto.Item(2).Text & "' And Codigo = '" & TxtTexto.Item(1).Text & "'")
                ...
                'ESTA PARTE ESTA PENDIENTE YA QUE NO HAY UNA ENTRADA DE PRODUCTO TERMNIADO COMERCIALIZADO
                'PARA PODER COMPARAR LO QUE ENTRO CON LO QUE YA A ENTRADO
                
                'BUSCA SI EL CODIGO PERTENECE AL DESPACHO
                'Set RBuscaDespacho = Db.OpenRecordset("Select * From DetalleEntradasProductoTerminado Where Documento = '" & TxtTexto.Item(0).Text & "' And FichaTecnica = '" & TxtTexto.Item(1).Text & "'")
                '    If RBuscaDespacho.RecordCount > 0 Then
                '    Else
                '        MsgBox "La Ficha Tecnica No Se Capturo Por Este Despacho " & TxtTexto.Item(0).Text, vbOKOnly + vbExclamation, "Advertencia"
                ...
                '________________________________________________________________________________________________________
                            ...
                            'Set RBuscaDespacho = Db.OpenRecordset("Select Sum(Cantidad) From DetalleEntradasProductoTerminado Where Documento = '" & TxtTexto.Item(0).Text & "' And FichaTecnica = '" & TxtTexto.Item(1).Text & "'")
                            '    If RBuscaDespacho.RecordCount > 0 Then
                            ...
                            'Set RBuscaPedido = Db.OpenRecordset("Select Sum(Cantidad) From CerrarPedidoProductoTerminadoClientes Where Documento = '" & TxtTexto.Item(0).Text & "' And FichaTecnica = '" & TxtTexto.Item(1).Text & "'")
                ...
                .Update
                        ...
                        If Err = 3022 Then
                                MsgBox "El Codigo De Ficha Tecnica Ya Esta Ingresado Con Este Documento Para Este Pedido", vbOKOnly + vbExclamation, "Verifique"
                                Exit Sub
                ...
                Set RBuscaPedido = Db.OpenRecordset("Select CantidadEntregada, SaldoPorEntregar, FechaParaEntregar, FechaEntregaTotal, DiasDeAtraso From PedidosProductoTerminadoProveedores Where Documento = '" & VNumeroPedido & "' And Codigo = '" & VCodigo & "'")
                    If RBuscaPedido.RecordCount > 0 Then
        ...
        ElseIf Index = 6 Then 'SELECCIONAR DATOS
                    ...
                    If OptBusqueda.Item(0).Value = True Then
                        DataCerrarPedidos.RecordSource = ("Select * From CerrarPedidoProductoTerminadoClientes where Documento = '" & TxtBusqueda.Text & "' Order By FechaRecepcion")
                    'FECHAS
                    ElseIf OptBusqueda.Item(1).Value = True Then
                        DataCerrarPedidos.RecordSource = ("Select * From CerrarPedidoProductoTerminadoClientes where FechaRecepcion >= #" & Format(DtpFecIni.Value, "mm/dd/yyyy") & "# And FechaRecepcion <= #" & Format(DtpFecFin.Value, "mm/dd/yyyy") & "# Order By FechaRecepcion")
                    'PEDIDO
                    ElseIf OptBusqueda.Item(1).Value = True Then
                        DataCerrarPedidos.RecordSource = ("Select * From CerrarPedidoProductoTerminadoClientes where Pedido = '" & TxtBusqueda.Text & "' Order By FechaRecepcion")
                    End If
                    DataCerrarPedidos.Refresh
                    DGridCerrarPedidos.Refresh
                    TabDepartamentos.Tab = 1
        ElseIf Index = 7 Then 'ACTUALIZAR
                    DataCerrarPedidos.RecordSource = "Select * From CerrarPedidoProductoTerminadoClientes Order By FechaRecepcion"
                    DataCerrarPedidos.Refresh
                    DGridCerrarPedidos.Refresh
                    TabDepartamentos.Tab = 1
        End If
...
Private Sub DGridCerrarPedidos_HeadClick(ByVal ColIndex As Integer)
        DataCerrarPedidos.RecordSource = "Select * from CerrarPedidoProductoTerminadoClientes Order by " & DGridCerrarPedidos.Columns(ColIndex).DataField
        DataCerrarPedidos.Refresh
        DGridCerrarPedidos.Refresh
End Sub
...
Private Sub TxtTexto_DblClick(Index As Integer)
    ...
    If Index = 1 Then
        'DataBusqueda.RecordSource = "Select Codigo, Sum(Cantidad) From DetalleEntradasProductoTerminado Where Documento = '" & TxtTexto.Item(0).Text & "' Group By Codigo"
        'BMateriaPrima = True
        'BPedido = False
    'BUSCA TODOS LOS PEDIDOS DE LA MATERIA PRIMA
    ElseIf Index = 2 Then
        DataBusqueda.RecordSource = "Select P.FechaPedido, P.Documento, P.CantidadPedido, P.CantidadEntregada, P.SaldoPorEntregar, Pr.Proveedor From PedidosProductoTerminadoProveedores As P, Proveedores as Pr Where P.Codigo = '" & TxtTexto.Item(1).Text & "' And P.SaldoPorEntregar > 0 And P.Proveedor = Pr.CodigoProveedor"
        BMateriaPrima = False
        BPedido = True
    End If
        ...
        DBGridBusqueda.Refresh
                    ...
                    ElseIf Index = 2 Then
                        ...
                        DBGridBusqueda.Columns(5).Caption = "Proveedor"
...
Private Sub TxtTexto_KeyPress(Index As Integer, KeyAscii As Integer)
        ...
        If KeyAscii = 43 Then
                ...
                If Index = 1 Then
                    'DataBusqueda.RecordSource = "Select FichaTecnica, Sum(Cantidad) From DetalleEntradasProductoTerminado Where Documento = '" & TxtTexto.Item(0).Text & "' Group By FichaTecnica"
                    'BMateriaPrima = True
                    'BPedido = False
                'BUSCA TODOS LOS PEDIDOS DE LA MATERIA PRIMA
                ElseIf Index = 2 Then
...
Private Sub TxtTexto_LostFocus(Index As Integer)
        'NUMERO DE RECEPCION
        If Index = 0 Then
                'Set RBuscaDespacho = Db.OpenRecordset("Select Fecha From EncabezadoEntradasProductoTerminado Where Documento = '" & TxtTexto.Item(0).Text & "'")
                '    If RBuscaDespacho.RecordCount > 0 Then
        ...
        If Index = 1 Then
                'BUSCA LA CANTIDAD QUE TRAE EL DESPACHO
                'Set RBuscaCantidadRecepcion = Db.OpenRecordset("Select Sum(Cantidad) From DetalleEntradasProductoTerminado Where Documento = '" & TxtTexto.Item(0).Text & "' And FichaTecnica = '" & TxtTexto.Item(1).Text & "'")
                ...
                'BUSCA LA CANTIDAD QUE TIENE EL CIERRE DE PEDIDOS
                'Set RBuscaCantidadPedido = Db.OpenRecordset("Select Sum(Cantidad) From CerrarPedidoProductoTerminadoClientes Where Documento = '" & TxtTexto.Item(0).Text & "' And FichaTecnica = '" & TxtTexto.Item(1).Text & "'")
