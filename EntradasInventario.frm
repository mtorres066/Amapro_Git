...
Begin VB.Form InventarioEntradas 
   ...
   ClientTop       =   345
   ClientWidth     =   11955
   Icon            =   "EntradasInventario.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8595
   ...
   Begin VB.Frame FrameBuscar 
      ...
      Begin VB.CommandButton Command1 
         Height          =   615
         Left            =   10800
         Picture         =   "EntradasInventario.frx":08CA
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin MSDBGrid.DBGrid DBGridBuscar 
         Bindings        =   "EntradasInventario.frx":293C
         Height          =   7335
         Left            =   120
         OleObjectBlob   =   "EntradasInventario.frx":2955
         TabIndex        =   4
   ...
   Begin TabDlg.SSTab TabEntradas 
      ...
      TabPicture(0)   =   "EntradasInventario.frx":332D
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "FrameEncabezado"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Detalle"
      TabPicture(1)   =   "EntradasInventario.frx":377F
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "FrameDetalle"
      Tab(1).Control(1)=   "DBGridDetalleEntradas"
      Tab(1).ControlCount=   2
      Begin MSDBGrid.DBGrid DBGridDetalleEntradas 
         Bindings        =   "EntradasInventario.frx":3A99
         Height          =   4575
         Left            =   -74760
         OleObjectBlob   =   "EntradasInventario.frx":3ABB
         TabIndex        =   77
         TabStop         =   0   'False
         Top             =   2640
         Width           =   11415
      ...
      Begin VB.Frame FrameDetalle 
         ...
         Begin VB.CommandButton CmdAgregar2 
            ...
            Height          =   495
            Left            =   240
            Picture         =   "EntradasInventario.frx":58C4
            Style           =   1  'Graphical
            TabIndex        =   56
            Top             =   6600
            Visible         =   0   'False
         ...
         Begin VB.CommandButton CmdGrabar2 
            ...
            Height          =   495
            Left            =   3840
            Picture         =   "EntradasInventario.frx":5DF6
            Style           =   1  'Graphical
            TabIndex        =   58
            Top             =   6600
            Visible         =   0   'False
         ...
         Begin VB.CommandButton CmdTerminar 
            ...
            Height          =   495
            Left            =   9240
            Picture         =   "EntradasInventario.frx":6328
            TabIndex        =   61
            Top             =   6600
            Visible         =   0   'False
            Width           =   1815
         ...
         Begin VB.CommandButton CmdCancelar2 
            ...
            Height          =   495
            Left            =   5640
            Picture         =   "EntradasInventario.frx":685A
            Style           =   1  'Graphical
            TabIndex        =   59
            Top             =   6600
            Visible         =   0   'False
         ...
         Begin VB.CommandButton CmdBorrar2 
            ...
            Height          =   495
            Left            =   7440
            Picture         =   "EntradasInventario.frx":6D8C
            Style           =   1  'Graphical
            TabIndex        =   60
            Top             =   6600
            Visible         =   0   'False
         ...
         Begin VB.CommandButton CmdEditar2 
            ...
            Height          =   495
            Left            =   2040
            Picture         =   "EntradasInventario.frx":72BE
            Style           =   1  'Graphical
            TabIndex        =   57
            Top             =   6600
            Visible         =   0   'False
      ...
      Begin VB.Frame FrameEncabezado 
         ...
         Begin VB.CommandButton CmdAgregar 
            ...
            Height          =   700
            Left            =   120
            Picture         =   "EntradasInventario.frx":77F0
            Style           =   1  'Graphical
            TabIndex        =   11
            Top             =   3240
            Width           =   1200
         ...
         Begin VB.CommandButton CmdGrabar 
            ...
            Height          =   700
            Left            =   2760
            Picture         =   "EntradasInventario.frx":7D22
            Style           =   1  'Graphical
            TabIndex        =   13
            Top             =   3240
            Width           =   1200
         ...
         Begin VB.CommandButton CmdCancelar 
            ...
            Height          =   700
            Left            =   4080
            Picture         =   "EntradasInventario.frx":8254
            Style           =   1  'Graphical
            TabIndex        =   14
            Top             =   3240
            Width           =   1200
         ...
         Begin VB.CommandButton CmdBorrar 
            ...
            Height          =   700
            Left            =   5400
            Picture         =   "EntradasInventario.frx":8786
            Style           =   1  'Graphical
            TabIndex        =   15
            Top             =   3240
            Width           =   1200
         ...
         Begin VB.CommandButton CmdSalida 
            ...
            Height          =   700
            Left            =   10920
            Picture         =   "EntradasInventario.frx":8CB8
            Style           =   1  'Graphical
            TabIndex        =   20
            ToolTipText     =   "Salida"
            Top             =   3240
         ...
         Begin VB.CommandButton CmdBuscar 
            ...
            Height          =   700
            Left            =   6720
            Picture         =   "EntradasInventario.frx":AD2A
            Style           =   1  'Graphical
            TabIndex        =   16
            Top             =   3240
            Width           =   1200
         ...
         Begin VB.CommandButton CmdEditar 
            ...
            Height          =   700
            Left            =   1440
            Picture         =   "EntradasInventario.frx":B25C
            Style           =   1  'Graphical
            TabIndex        =   12
            Top             =   3240
            Width           =   1200
         ...
         Begin VB.CommandButton CmdImprimir 
            ...
            Height          =   700
            Left            =   8040
            Picture         =   "EntradasInventario.frx":B78E
            Style           =   1  'Graphical
            TabIndex        =   17
            Top             =   3240
            Width           =   1300
         ...
         Begin VB.CommandButton CmdImprimirAmarillas 
            ...
            Height          =   700
            Left            =   9480
            Picture         =   "EntradasInventario.frx":BCC0
            Style           =   1  'Graphical
            TabIndex        =   19
            Top             =   3240
            Width           =   1320
