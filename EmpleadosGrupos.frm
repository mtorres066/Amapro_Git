...
Begin VB.Form EmpleadosGrupos 
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   1
      Left            =   120
      MouseIcon       =   "EmpleadosGrupos.frx":0442
      Picture         =   "EmpleadosGrupos.frx":0884
      Style           =   1  'Graphical
      TabIndex        =   25
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   2
      Left            =   480
      MouseIcon       =   "EmpleadosGrupos.frx":0DB6
      Picture         =   "EmpleadosGrupos.frx":11F8
      Style           =   1  'Graphical
      TabIndex        =   24
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   3
      Left            =   7440
      MouseIcon       =   "EmpleadosGrupos.frx":172A
      Picture         =   "EmpleadosGrupos.frx":1B6C
      Style           =   1  'Graphical
      TabIndex        =   23
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   4
      Left            =   7800
      MouseIcon       =   "EmpleadosGrupos.frx":209E
      Picture         =   "EmpleadosGrupos.frx":24E0
      Style           =   1  'Graphical
      TabIndex        =   22
   ...
   Begin TabDlg.SSTab TabPuestos 
      ...
      TabPicture(0)   =   "EmpleadosGrupos.frx":2A12
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "FramePuestos"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Vista General"
      TabPicture(1)   =   "EmpleadosGrupos.frx":2D2C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "DataGrid1"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "Busqueda De Datos"
      TabPicture(2)   =   "EmpleadosGrupos.frx":317E
      ...
      Begin VB.CommandButton CmdBuscar 
         ...
         Index           =   1
         Left            =   -68760
         Picture         =   "EmpleadosGrupos.frx":35D0
         Style           =   1  'Graphical
         TabIndex        =   21
         Top             =   3240
         Width           =   2055
      ...
      Begin VB.CommandButton CmdBuscar 
         ...
         Index           =   0
         Left            =   -68760
         Picture         =   "EmpleadosGrupos.frx":38DA
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   2280
         Width           =   2055
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   5
      Left            =   6360
      MouseIcon       =   "EmpleadosGrupos.frx":3D1C
      Picture         =   "EmpleadosGrupos.frx":415E
      Style           =   1  'Graphical
      TabIndex        =   8
      Top             =   4320
      Width           =   1000
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   4
      Left            =   5280
      MouseIcon       =   "EmpleadosGrupos.frx":61D0
      Picture         =   "EmpleadosGrupos.frx":6612
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   4320
      Width           =   1000
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   3
      Left            =   4200
      MouseIcon       =   "EmpleadosGrupos.frx":6B44
      Picture         =   "EmpleadosGrupos.frx":6F86
      Style           =   1  'Graphical
      TabIndex        =   6
      Top             =   4320
      Width           =   1000
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   2
      Left            =   3120
      MouseIcon       =   "EmpleadosGrupos.frx":74B8
      Picture         =   "EmpleadosGrupos.frx":78FA
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   4320
      Width           =   1000
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   1
      Left            =   2040
      MouseIcon       =   "EmpleadosGrupos.frx":7E2C
      Picture         =   "EmpleadosGrupos.frx":826E
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   4320
      Width           =   1000
   ...
   Begin VB.CommandButton CmdBotones 
      ...
      Index           =   0
      Left            =   960
      MouseIcon       =   "EmpleadosGrupos.frx":87A0
      Picture         =   "EmpleadosGrupos.frx":8BE2
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   4320
      Width           =   1000
   End
End
Attribute VB_Name = "EmpleadosGrupos"
    ...
    On Error Resume Next
            ...
            ElseIf Index = 2 Then
                    If BEditar = False Then 'ESTA AGREGANDO UN REGISTRO
                         Conexion.Execute "Insert Into EmpleadosGrupos Values('" & TxtTexto.Item(0).Text & "', '" & TxtTexto.Item(1).Text & "', '" & TxtTexto.Item(2).Text & "')"
                    Else 'ESTA EDITANDO UN REGISTRO
                         Conexion.Execute "UPDATE EmpleadosGrupos SET Descripcion = '" & TxtTexto.Item(1).Text & "', Usuario = '" & TxtTexto.Item(2).Text & "' Where Codigo = '" & TxtTexto.Item(0).Text & "'"
                    End If
                    
                    'SI SE DUPLICA LA LLAVE
                     If GOrigenDeDatos = "AmaproAccess" Then
                        If Err = -2147467259 Then
                            MsgBox "Codigo De Equipo Ya Existe", vbOKOnly + vbInformation, "Informacion"
                            TxtTexto.Item(0).SetFocus
                            Exit Sub
...
Private Sub CmdBuscar_Click(Index As Integer)
        ...
        If Index = 0 Then
            If OptCodigo.Value = True Then
                If GOrigenDeDatos = "AmaproAccess" Then
                    Call Abrir_Recordset(RDocumentos, "Select * from EmpleadosGrupos where Codigo Like '%" & TxtBuscar.Text & "%'")
                Else 'ORACLE
                    Call Abrir_Recordset(RDocumentos, "Select * from EmpleadosGrupos where UPPER(Codigo) Like '%" & UCase(TxtBuscar.Text) & "%'")
                End If
            ElseIf OptDescripcion.Value = True Then
                If GOrigenDeDatos = "AmaproAccess" Then
                    Call Abrir_Recordset(RDocumentos, "Select * from EmpleadosGrupos where Descripcion Like '%" & TxtBuscar.Text & "%'")
                Else 'ORACLE
                    Call Abrir_Recordset(RDocumentos, "Select * from EmpleadosGrupos where UPPER(Descripcion) Like '%" & UCase(TxtBuscar.Text) & "%'")
                End If
            End If
        'SELECCIONAR TODOS LOS DATOS
        ElseIf Index = 1 Then
                Call Abrir_Recordset(RDocumentos, "Select * From EmpleadosGrupos")
        End If
