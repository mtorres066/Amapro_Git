...
Begin VB.Form Inventario 
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   4
      Left            =   7800
      MouseIcon       =   "Venas.frx":237C
      Picture         =   "Venas.frx":27BE
      Style           =   1  'Graphical
      TabIndex        =   28
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   3
      Left            =   7440
      MouseIcon       =   "Venas.frx":2CF0
      Picture         =   "Venas.frx":3132
      Style           =   1  'Graphical
      TabIndex        =   27
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   2
      Left            =   480
      MouseIcon       =   "Venas.frx":3664
      Picture         =   "Venas.frx":3AA6
      Style           =   1  'Graphical
      TabIndex        =   26
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   1
      Left            =   120
      MouseIcon       =   "Venas.frx":3FD8
      Picture         =   "Venas.frx":441A
      Style           =   1  'Graphical
      TabIndex        =   25
   ...
   Begin VB.CommandButton CmdSalida 
      ...
      Height          =   800
      Left            =   6240
      MouseIcon       =   "Venas.frx":750E
      Picture         =   "Venas.frx":7950
      Style           =   1  'Graphical
      TabIndex        =   9
      Top             =   5160
      Width           =   1065
   ...
   Begin VB.CommandButton CmdBorrar 
      ...
      Height          =   800
      Left            =   4920
      MouseIcon       =   "Venas.frx":99C2
      Picture         =   "Venas.frx":9E04
      Style           =   1  'Graphical
      TabIndex        =   8
      Top             =   5160
      Width           =   1200
   ...
   Begin VB.CommandButton CmdCancelar 
      ...
      Height          =   800
      Left            =   3600
      MouseIcon       =   "Venas.frx":A336
      Picture         =   "Venas.frx":A778
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   5160
      Width           =   1200
   ...
   Begin VB.CommandButton CmdGrabar 
      ...
      Height          =   800
      Left            =   2280
      MouseIcon       =   "Venas.frx":ACAA
      Picture         =   "Venas.frx":B0EC
      Style           =   1  'Graphical
      TabIndex        =   6
      Top             =   5160
      Width           =   1200
   ...
   Begin VB.CommandButton CmdAgregar 
      ...
      Height          =   800
      Left            =   960
      MouseIcon       =   "Venas.frx":B61E
      Picture         =   "Venas.frx":BA60
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   5160
      Width           =   1200
...
Private Sub CmdBuscar_Click(Index As Integer)
    ...
    If Index = 0 Then
            If OptOpcion.Item(0).Value = True Then
                If GOrigenDeDatos = "AmaproAccess" Then
                    Call Abrir_Recordset(RInventario, "Select * from Inventario where Fecha >= #" & Format(DtpFecIni.Value, "mm/dd/yyyy") & "# And Fecha <= #" & Format(DtpFecFin.Value, "mm/dd/yyyy") & "# And Bodega = '" & TxtBuscar.Text & "'")
                Else
                    Call Abrir_Recordset(RInventario, "Select * from Inventario where Fecha >= To_Date('" & DtpFecIni.Value & "', 'dd/mm/yyyy')" & " And Fecha <= To_Date('" & DtpFecFin.Value & "', 'dd/mm/yyyy')" & " And UPPER(Bodega) = '" & UCase(TxtBuscar.Text) & "'")
                End If
