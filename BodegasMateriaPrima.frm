...
Begin VB.Form BodegasMateriasPrimas 
   BackColor       =   &H00008000&
   Caption         =   "Bodegas De Materias Primas"
   ClientHeight    =   4710
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8415
   Icon            =   "BodegasMateriaPrima.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   4710
   ...
   Begin VB.Frame FrameBusqueda 
      ...
      Begin VB.CommandButton CmdSale 
         Height          =   615
         Left            =   7800
         Picture         =   "BodegasMateriaPrima.frx":0442
         Style           =   1  'Graphical
         TabIndex        =   38
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   4
      Left            =   7800
      MouseIcon       =   "BodegasMateriaPrima.frx":24B4
      Picture         =   "BodegasMateriaPrima.frx":28F6
      Style           =   1  'Graphical
      TabIndex        =   45
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   3
      Left            =   7440
      MouseIcon       =   "BodegasMateriaPrima.frx":2E28
      Picture         =   "BodegasMateriaPrima.frx":326A
      Style           =   1  'Graphical
      TabIndex        =   44
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   2
      Left            =   480
      MouseIcon       =   "BodegasMateriaPrima.frx":379C
      Picture         =   "BodegasMateriaPrima.frx":3BDE
      Style           =   1  'Graphical
      TabIndex        =   43
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   1
      Left            =   120
      MouseIcon       =   "BodegasMateriaPrima.frx":4110
      Picture         =   "BodegasMateriaPrima.frx":4552
      Style           =   1  'Graphical
      TabIndex        =   42
   ...
   Begin TabDlg.SSTab TabBodegas 
      ...
      TabPicture(0)   =   "BodegasMateriaPrima.frx":4A84
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "FrameBodegas"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Vista General"
      TabPicture(1)   =   "BodegasMateriaPrima.frx":4D9E
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "DataGrid1"
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "Busqueda De Datos"
      TabPicture(2)   =   "BodegasMateriaPrima.frx":51F0
      ...
      Begin VB.CommandButton CmdBuscar 
         ...
         Index           =   1
         Left            =   -68760
         Picture         =   "BodegasMateriaPrima.frx":5642
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   2880
         Width           =   1812
      ...
      Begin VB.CommandButton CmdBuscar 
         ...
         Index           =   0
         Left            =   -68760
         Picture         =   "BodegasMateriaPrima.frx":594C
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   2040
         Width           =   1812
   ...
   Begin VB.CommandButton CmdSalida 
      ...
      Height          =   800
      Left            =   6360
      MouseIcon       =   "BodegasMateriaPrima.frx":7646
      Picture         =   "BodegasMateriaPrima.frx":7A88
      Style           =   1  'Graphical
      TabIndex        =   13
      Top             =   3840
      Width           =   1000
   ...
   Begin VB.CommandButton CmdBorrar 
      ...
      Height          =   800
      Left            =   5280
      MouseIcon       =   "BodegasMateriaPrima.frx":9AFA
      Picture         =   "BodegasMateriaPrima.frx":9F3C
      Style           =   1  'Graphical
      TabIndex        =   12
      Top             =   3840
      Width           =   1000
   ...
   Begin VB.CommandButton CmdCancelar 
      ...
      Height          =   800
      Left            =   4200
      MouseIcon       =   "BodegasMateriaPrima.frx":A46E
      Picture         =   "BodegasMateriaPrima.frx":A8B0
      Style           =   1  'Graphical
      TabIndex        =   11
      Top             =   3840
      Width           =   1000
   ...
   Begin VB.CommandButton CmdGrabar 
      ...
      Height          =   800
      Left            =   3120
      MouseIcon       =   "BodegasMateriaPrima.frx":ADE2
      Picture         =   "BodegasMateriaPrima.frx":B224
      Style           =   1  'Graphical
      TabIndex        =   10
      Top             =   3840
      Width           =   1000
   ...
   Begin VB.CommandButton CmdEditar 
      ...
      Height          =   800
      Left            =   2040
      MouseIcon       =   "BodegasMateriaPrima.frx":B756
      Picture         =   "BodegasMateriaPrima.frx":BB98
      Style           =   1  'Graphical
      TabIndex        =   9
      Top             =   3840
      Width           =   1000
   ...
   Begin VB.CommandButton CmdAgregar 
      ...
      Height          =   800
      Left            =   960
      MouseIcon       =   "BodegasMateriaPrima.frx":C0CA
      Picture         =   "BodegasMateriaPrima.frx":C50C
      Style           =   1  'Graphical
      TabIndex        =   8
      Top             =   3840
      Width           =   1000
   End
End
Attribute VB_Name = "BodegasMateriasPrimas"
...
Private Sub CmdBuscar_Click(Index As Integer)
    ...
    If Index = 0 Then
        If OptCodigo.Value = True Then
            Call Abrir_Recordset(RBodegasMateriaPrima, "Select * from BodegasMateriaPrima where CodigoBodega like '" & TxtBuscar.Text & "%'")
        ElseIf OptNombre.Value = True Then
            Call Abrir_Recordset(RBodegasMateriaPrima, "Select * from BodegasMateriaPrima where Descripcion like '" & TxtBuscar.Text & "%'")
        End If
    ElseIf Index = 1 Then
...
On Error Resume Next
                    ...
                    If BEditar = False Then
                            ...
                            Conexion.Execute "Insert Into BodegasMateriaPrima " & VTexto
                    'EDITAR
                    Else
                            ...
                            Conexion.Execute "UPDATE BodegasMateriaPrima SET " & VTexto
                    End If
