...
Begin VB.Form CerrarPedidoProductoTerminadoClientes 
   BackColor       =   &H00FF8080&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Cerrar Pedidos De Producto Terminado De Clientes"
   ClientHeight    =   6345
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9315
   Icon            =   "CerrarPedidoProductoTerminadoClientes.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6345
   ...
   Begin VB.Frame FrameBusqueda 
      ...
      Begin VB.CommandButton CmdSale 
         Height          =   615
         Left            =   8160
         Picture         =   "CerrarPedidoProductoTerminadoClientes.frx":08CA
         Style           =   1  'Graphical
         TabIndex        =   30
      ...
      Begin MSDBGrid.DBGrid DBGridBusqueda 
         Bindings        =   "CerrarPedidoProductoTerminadoClientes.frx":293C
         Height          =   5775
         Left            =   120
         OleObjectBlob   =   "CerrarPedidoProductoTerminadoClientes.frx":2957
         TabIndex        =   29
   ...
   Begin VB.Data DataCerrarPedidos 
      ...
      ReadOnly        =   0   'False
      RecordsetType   =   1  'Dynaset
      RecordSource    =   "CerrarPedidoProductoTerminadoClientes"
      Top             =   5040
      Width           =   9135
   End
   Begin TabDlg.SSTab TabDepartamentos 
      ...
      TabPicture(0)   =   "CerrarPedidoProductoTerminadoClientes.frx":3331
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "FrameCerrarPedidos"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Vista General"
      TabPicture(1)   =   "CerrarPedidoProductoTerminadoClientes.frx":364B
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "DGridCerrarPedidos"
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "Busqueda"
      TabPicture(2)   =   "CerrarPedidoProductoTerminadoClientes.frx":3A9D
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "FrameBusquedadeDatos"
      Tab(2).ControlCount=   1
      Begin MSDBGrid.DBGrid DGridCerrarPedidos 
         Bindings        =   "CerrarPedidoProductoTerminadoClientes.frx":3EEF
         Height          =   3975
         Left            =   -74880
         OleObjectBlob   =   "CerrarPedidoProductoTerminadoClientes.frx":3F0F
         TabIndex        =   13
      ...
      Begin VB.Frame FrameBusquedadeDatos 
         ...
         Begin VB.OptionButton OptBusqueda 
            ...
            Index           =   2
            Left            =   3000
            Picture         =   "CerrarPedidoProductoTerminadoClientes.frx":5181
            Style           =   1  'Graphical
            TabIndex        =   37
            Top             =   360
            Width           =   1335
         ...
         Begin VB.OptionButton OptBusqueda 
            ...
            Index           =   1
            Left            =   1560
            Picture         =   "CerrarPedidoProductoTerminadoClientes.frx":548B
            Style           =   1  'Graphical
            TabIndex        =   16
            Top             =   360
            Width           =   1335
         ...
         Begin VB.OptionButton OptBusqueda 
            ...
            Index           =   0
            Left            =   120
            Picture         =   "CerrarPedidoProductoTerminadoClientes.frx":8305
            Style           =   1  'Graphical
            TabIndex        =   15
            Top             =   360
            Value           =   -1  'True
         ...
         Begin MSForms.CommandButton CmdBotones 
            ...
            PicturePosition =   196613
            Size            =   "4471;1085"
            Picture         =   "CerrarPedidoProductoTerminadoClientes.frx":D907
            FontEffects     =   1073741825
            FontHeight      =   165
            FontCharSet     =   0
            FontPitchAndFamily=   2
      ...
      Begin VB.Frame FrameCerrarPedidos 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   3840
            Picture         =   "CerrarPedidoProductoTerminadoClientes.frx":DD59
            Top             =   480
            Width           =   480
         End
   ...
   Begin MSForms.CommandButton CmdBotones 
      ...
      PicturePosition =   196613
      Size            =   "3175;1085"
      Picture         =   "CerrarPedidoProductoTerminadoClientes.frx":E623
      Accelerator     =   65
      FontEffects     =   1073741825
      FontHeight      =   165
      FontCharSet     =   0
   ...
   Begin MSForms.CommandButton CmdBotones 
      ...
      PicturePosition =   196613
      Size            =   "3175;1085"
      Picture         =   "CerrarPedidoProductoTerminadoClientes.frx":EB65
      Accelerator     =   71
   ...
   Begin MSForms.CommandButton CmdBotones 
      ...
      PicturePosition =   196613
      Size            =   "3175;1085"
      Picture         =   "CerrarPedidoProductoTerminadoClientes.frx":F0A7
      Accelerator     =   67
      FontEffects     =   1073750017
      FontHeight      =   165
      FontCharSet     =   0
   ...
   Begin MSForms.CommandButton CmdBotones 
      ...
      PicturePosition =   196613
      Size            =   "3175;1085"
      Picture         =   "CerrarPedidoProductoTerminadoClientes.frx":F5E9
      Accelerator     =   66
      FontEffects     =   1073741825
      FontHeight      =   165
      FontCharSet     =   0
   ...
   Begin MSForms.CommandButton CmdBotones 
      ...
      PicturePosition =   196613
      Size            =   "3387;1085"
      Picture         =   "CerrarPedidoProductoTerminadoClientes.frx":FB2B
      Accelerator     =   83
      FontEffects     =   1073741825
      FontHeight      =   165
      FontCharSet     =   0
   ...
   End
End
Attribute VB_Name = "CerrarPedidoProductoTerminadoClientes"
...
On Error Resume Next
    With DataCerrarPedidos.Recordset
        ...
        ElseIf Index = 2 Then
                ...
                Set RBuscaPedido2 = Db.OpenRecordset("Select * From PedidosProductoTerminadoClientes Where Documento = '" & TxtTexto.Item(2).Text & "'")
                ...
                Set RBuscaPedido3 = Db.OpenRecordset("Select * From PedidosProductoTerminadoClientes Where Documento = '" & TxtTexto.Item(2).Text & "' And Codigo = '" & TxtTexto.Item(1).Text & "'")
                ...
                Set RBuscaSaldo = Db.OpenRecordset("Select SaldoPorEntregar From PedidosProductoTerminadoClientes Where Documento = '" & TxtTexto.Item(2).Text & "'" & " And Codigo = '" & TxtTexto.Item(1).Text & "'")
                ...
                Set RBuscaDespacho = Db.OpenRecordset("Select * From DetalleDespachosProductoTerminado Where Documento = '" & TxtTexto.Item(0).Text & "' And FichaTecnica = '" & TxtTexto.Item(1).Text & "'")
                ...
                '________________________________________________________________________________________________________
                            ...
                            Set RBuscaDespacho = Db.OpenRecordset("Select Sum(Cantidad) From DetalleDespachosProductoTerminado Where Documento = '" & TxtTexto.Item(0).Text & "' And FichaTecnica = '" & TxtTexto.Item(1).Text & "'")
                                If RBuscaDespacho.RecordCount > 0 Then
                ...
                .Update
                        ...
                        If Err = 3022 Then
                                MsgBox "El Codigo De Ficha Tecnica Ya Esta Ingresado Con Este Despacho Para Este Pedido", vbOKOnly + vbExclamation, "Verifique"
                                Exit Sub
                ...
                Set RBuscaPedido = Db.OpenRecordset("Select CantidadEntregada, SaldoPorEntregar, FechaParaEntregar, FechaEntregaTotal, DiasDeAtraso From PedidosProductoTerminadoClientes Where Documento = '" & VNumeroPedido & "'" & " And Codigo = '" & VCodigo & "'")
                    If RBuscaPedido.RecordCount > 0 Then
...
Private Sub TxtTexto_DblClick(Index As Integer)
    ...
    If Index = 1 Then
        DataBusqueda.RecordSource = "Select Codigo, Sum(Cantidad) From DetalleDespachosProductoTerminado Where Documento = '" & TxtTexto.Item(0).Text & "' Group By Codigo"
        BMateriaPrima = True
        BPedido = False
    'BUSCA TODOS LOS PEDIDOS DE LA MATERIA PRIMA
    ElseIf Index = 2 Then
        DataBusqueda.RecordSource = "Select P.FechaPedido, P.Documento, P.CantidadPedido, P.CantidadEntregada, P.SaldoPorEntregar, C.Descripcion From PedidosProductoTerminadoClientes As P, Clientes as C Where P.Codigo = '" & TxtTexto.Item(1).Text & "' And P.SaldoPorEntregar > 0 And P.Cliente = C.CodigoCliente"
        BMateriaPrima = False
        BPedido = True
    End If
...
Private Sub TxtTexto_KeyPress(Index As Integer, KeyAscii As Integer)
        ...
        If KeyAscii = 43 Then
                ...
                If Index = 1 Then
                    DataBusqueda.RecordSource = "Select FichaTecnica, Sum(Cantidad) From DetalleDespachosProductoTerminado Where Documento = '" & TxtTexto.Item(0).Text & "' Group By FichaTecnica"
                    BMateriaPrima = True
                    BPedido = False
                'BUSCA TODOS LOS PEDIDOS DE LA MATERIA PRIMA
                ElseIf Index = 2 Then
...
Private Sub TxtTexto_LostFocus(Index As Integer)
        'NUMERO DE RECEPCION
        If Index = 0 Then
                Set RBuscaDespacho = Db.OpenRecordset("Select Fecha From EncabezadoDespachosProductoTerminado Where Documento = '" & TxtTexto.Item(0).Text & "'")
                    If RBuscaDespacho.RecordCount > 0 Then
        ...
        If Index = 1 Then
                'BUSCA LA CANTIDAD QUE TRAE EL DESPACHO
                Set RBuscaCantidadRecepcion = Db.OpenRecordset("Select Sum(Cantidad) From DetalleDespachosProductoTerminado Where Documento = '" & TxtTexto.Item(0).Text & "' And FichaTecnica = '" & TxtTexto.Item(1).Text & "'")
