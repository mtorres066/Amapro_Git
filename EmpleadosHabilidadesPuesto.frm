...
Begin VB.Form EmpleadosHabilidadesPuesto 
   BackColor       =   &H0080C0FF&
   Caption         =   "Habilidades Del Puesto"
   ClientHeight    =   4710
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8415
   Icon            =   "EmpleadosHabilidadesPuesto.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   4710
   ...
   Begin VB.Frame FrameBusqueda 
      ...
      Begin VB.CommandButton CmdSale 
         Height          =   735
         Left            =   7440
         Picture         =   "EmpleadosHabilidadesPuesto.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   19
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   4
      Left            =   7800
      MouseIcon       =   "EmpleadosHabilidadesPuesto.frx":237C
      Picture         =   "EmpleadosHabilidadesPuesto.frx":27BE
      Style           =   1  'Graphical
      TabIndex        =   24
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   3
      Left            =   7440
      MouseIcon       =   "EmpleadosHabilidadesPuesto.frx":2CF0
      Picture         =   "EmpleadosHabilidadesPuesto.frx":3132
      Style           =   1  'Graphical
      TabIndex        =   23
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   2
      Left            =   480
      MouseIcon       =   "EmpleadosHabilidadesPuesto.frx":3664
      Picture         =   "EmpleadosHabilidadesPuesto.frx":3AA6
      Style           =   1  'Graphical
      TabIndex        =   22
   ...
   Begin VB.CommandButton CmdBotones2 
      ...
      Index           =   1
      Left            =   120
      MouseIcon       =   "EmpleadosHabilidadesPuesto.frx":3FD8
      Picture         =   "EmpleadosHabilidadesPuesto.frx":441A
      Style           =   1  'Graphical
      TabIndex        =   21
   ...
   Begin TabDlg.SSTab TabBodegas 
      ...
      TabPicture(0)   =   "EmpleadosHabilidadesPuesto.frx":494C
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "FrameBodegas"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Vista General"
      TabPicture(1)   =   "EmpleadosHabilidadesPuesto.frx":4C66
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "DataGrid1"
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "Busqueda De Datos"
      TabPicture(2)   =   "EmpleadosHabilidadesPuesto.frx":50B8
      ...
      Begin VB.Frame FrameOpciones 
         ...
         Begin VB.CommandButton CmdBuscar 
            ...
            Index           =   0
            Left            =   6120
            Picture         =   "EmpleadosHabilidadesPuesto.frx":550A
            Style           =   1  'Graphical
            TabIndex        =   26
            Top             =   960
            Width           =   1812
         ...
         Begin VB.CommandButton CmdBuscar 
            ...
            Index           =   1
            Left            =   6120
            Picture         =   "EmpleadosHabilidadesPuesto.frx":7204
            Style           =   1  'Graphical
            TabIndex        =   27
            Top             =   1800
            Width           =   1812
   ...
   Begin VB.CommandButton CmdSalida 
      ...
      Height          =   800
      Left            =   6240
      MouseIcon       =   "EmpleadosHabilidadesPuesto.frx":750E
      Picture         =   "EmpleadosHabilidadesPuesto.frx":7950
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   3840
      Width           =   1065
   ...
   Begin VB.CommandButton CmdBorrar 
      ...
      Height          =   800
      Left            =   4920
      MouseIcon       =   "EmpleadosHabilidadesPuesto.frx":99C2
      Picture         =   "EmpleadosHabilidadesPuesto.frx":9E04
      Style           =   1  'Graphical
      TabIndex        =   6
      Top             =   3840
      Width           =   1200
   ...
   Begin VB.CommandButton CmdCancelar 
      ...
      Height          =   800
      Left            =   3600
      MouseIcon       =   "EmpleadosHabilidadesPuesto.frx":A336
      Picture         =   "EmpleadosHabilidadesPuesto.frx":A778
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   3840
      Width           =   1200
   ...
   Begin VB.CommandButton CmdGrabar 
      ...
      Height          =   800
      Left            =   2280
      MouseIcon       =   "EmpleadosHabilidadesPuesto.frx":ACAA
      Picture         =   "EmpleadosHabilidadesPuesto.frx":B0EC
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   3840
      Width           =   1200
   ...
   Begin VB.CommandButton CmdAgregar 
      ...
      Height          =   800
      Left            =   960
      MouseIcon       =   "EmpleadosHabilidadesPuesto.frx":B61E
      Picture         =   "EmpleadosHabilidadesPuesto.frx":BA60
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   3840
      Width           =   1200
   End
End
Attribute VB_Name = "EmpleadosHabilidadesPuesto"
...
Private Sub CmdBuscar_Click(Index As Integer)
    ...
    If Index = 0 Then
            Call Abrir_Recordset(RFaltas, "Select * from EmpleadosHabilidadesPuesto where CodigoEmpleado like '" & TxtBuscar.Text & "%'")
    ElseIf Index = 1 Then
            Call Abrir_Recordset(RFaltas, "Select * from EmpleadosHabilidadesPuesto")
    End If
...
On Error Resume Next
                    ...
                    Set RBuscaPuesto = New ADODB.Recordset
                        Call Abrir_Recordset(RBuscaPuesto, "Select CodigoPuesto From EmpleadosPuestos Where CodigoPuesto = '" & Txttexto.Item(0).Text & "'")
                            ...
                            VTexto = "Values('" & Txttexto.Item(0).Text & "', '" ' PUESTO
                            VTexto = VTexto & Txttexto.Item(1).Text & "', '" 'HABILIDAD
                            VTexto = VTexto & Txttexto.Item(6).Text & "')" 'USUARIO
                            
                            Conexion.Execute "Insert Into EmpleadosHabilidadesPuesto " & VTexto
...
Private Sub Txtbusqueda_Change()
            ...
            If BPuesto = True Then
                    ...
                    ElseIf OptBusqueda.Item(1).Value = True Then
                            If GOrigenDeDatos = "AmaproAccess" Then
                                Call Abrir_Recordset(RBusqueda, "Select CodigoPuesto, Descripcion From EmpleadosPuestos where Codigo Like '%" & TxtBusqueda.Text & "%'")
                            Else 'ORACLE
                                Call Abrir_Recordset(RBusqueda, "Select CodigoPuesto, Descripcion From EmpleadosPuestos where UPPER(Codigo) Like '%" & UCase(TxtBusqueda.Text) & "%'")
                            End If
                    End If
            ElseIf BHabilidad = True Then
                    'DESCRIPCION
...
On Error Resume Next
        ...
        Txttexto.Item(0).Text = RFaltas!CodigoPuesto
...
Private Sub TxtTexto_Change(Index As Integer)
        If Index = 0 Then
            Set RBuscaPuesto = New ADODB.Recordset
            Call Abrir_Recordset(RBuscaPuesto, "Select Descripcion From EmpleadosPuestos Where CodigoPuesto = '" & Txttexto.Item(0).Text & "'")
                If RBuscaPuesto.RecordCount > 0 Then
                    LblEmp.Caption = RBuscaPuesto!Descripcion
                Else
                    LblEmp.Caption = ""
                End If
        ElseIf Index = 1 Then
...
Private Sub TxtTexto_DblClick(Index As Integer)
        If Index = 0 Then
                ...
                Call Abrir_Recordset(RBuscaPuesto, "Select CodigoPuesto, Descripcion From EmpleadosPuestos")
                Set DBGridBusqueda.DataSource = RBuscaPuesto
        ElseIf Index = 1 Then
                BPuesto = False
                BHabilidad = True
                'INICIALIZAMOS EL RECORDSET
